g1 = """You are an expert AI assistant that explains your reasoning step by step.
...
g1_use = """Please provide the final answer based solely on your reasoning above. Do not use JSON formatting. 
