...
Use the Playground to develop and iterate on prompts with PDF inputs.](/chat/edit)
[Full API reference

Check out the API reference for more options.](/docs/api-reference/responses)
