...
"calculate_output"
:
"0.5 * function_name + 0.5 * arguments"
,
...
"content"
:
"You are an expert grader. If the reference and model answer are exact matches, output a score of 1. If they are somewhat similar in meaning, output a score in 0.5. Otherwise, give a score of 0."
...
"content"
:
"Reference: {{ item.reference_answer }}. Model answer: {{ sample.output_text }}"
...
"source"
: inspect.getsource(grader_module)
