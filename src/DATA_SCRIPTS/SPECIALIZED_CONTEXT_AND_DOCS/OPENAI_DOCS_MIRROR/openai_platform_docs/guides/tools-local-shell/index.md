...
The local shell tool is outdated. For new use cases, use the [`shell`](https://platform.openai.com/docs/guides/tools-shell) tool with GPT-5.1 instead. [Learn more](https://platform.openai.com/docs/guides/tools-shell).
