...
Embed a chat widget, customize its look and feel, and let OpenAI host and scale the backend](#embed-chatkit-in-your-frontend)[![Advanced integration](https://cdn.openai.com/API/docs/images/misc-4.png)

Advanced integration

Use any backend and the ChatKit SDKs to build your own custom ChatKit user experience](/docs/guides/custom-chatkit)
...
1. On your server, generate a client token.
   ...
   openai = OpenAI(api_key=os.environ[
   "OPENAI_API_KEY"
   ])
...
2. In your server-side code, pass in your workflow ID and secret key to the session endpoint.
   ...
   ,
       ...
       Authorization:
   "Bearer "
    + process.env.VITE_OPENAI_API_SECRET_KEY,
...
Add server-side storage, access control, tools, and other backend functionality.](https://github.com/openai/chatkit-python)
[ChatKit JS SDK
