...
*   [Overview](http://platform.openai.com/docs/guides/tools?timeout=30#page-top)
*   [Available tools](http://platform.openai.com/docs/guides/tools?timeout=30#available-tools)
*   [API usage](http://platform.openai.com/docs/guides/tools?timeout=30#usage-in-the-api)
