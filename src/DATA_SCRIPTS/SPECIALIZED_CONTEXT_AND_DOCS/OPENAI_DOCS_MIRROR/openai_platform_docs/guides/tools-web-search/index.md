...
*   [Overview](http://platform.openai.com/docs/guides/tools-web-search?timeout=30#page-top)
*   [Output and citations](http://platform.openai.com/docs/guides/tools-web-search?timeout=30#output-and-citations)
*   [Domain filtering](http://platform.openai.com/docs/guides/tools-web-search?timeout=30#domain-filtering)
*   [Sources](http://platform.openai.com/docs/guides/tools-web-search?timeout=30#sources)
*   [User location](http://platform.openai.com/docs/guides/tools-web-search?timeout=30#user-location)
*   [API compatibility](http://platform.openai.com/docs/guides/tools-web-search?timeout=30#api-compatibility)
*   [Usage notes](http://platform.openai.com/docs/guides/tools-web-search?timeout=30#usage-notes)
