...
"id"
:
"ws_67c9fa0502748190b7dd390736892e100be649c1a5ff9609"
,
...
"id"
:
"msg_67c9fa077e288190af08fdffda2e34f20be649c1a5ff9609"
,
...
input
:
"Find the sunrise time in Paris today and cite the source."
,
...
| --- | --- | --- |
| [Responses](/docs/api-reference/responses)  [Chat Completions](/docs/api-reference/chat)  [Assistants](/docs/api-reference/assistants) | Same as tiered rate limits for underlying [model](/docs/models) used with the tool. | [Pricing](/docs/pricing#built-in-tools)   [ZDR and data residency](/docs/guides/your-data) |
