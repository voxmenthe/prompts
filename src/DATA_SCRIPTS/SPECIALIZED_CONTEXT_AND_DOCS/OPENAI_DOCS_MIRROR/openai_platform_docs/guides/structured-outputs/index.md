...
[Function Calling](/docs/guides/function-calling#function-calling-with-structured-outputs)
...
| **Adheres to schema** | Yes (see [supported schemas](/docs/guides/structured-outputs#supported-schemas)) | No |
...
models](/docs/guides/structured-outputs#some-type-specific-keywords-are-not-yet-supported).
