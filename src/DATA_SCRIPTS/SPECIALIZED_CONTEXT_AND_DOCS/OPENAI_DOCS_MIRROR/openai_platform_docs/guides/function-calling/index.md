...
*   [Overview](http://platform.openai.com/docs/guides/function-calling?timeout=30#page-top)
*   [Function tool example](http://platform.openai.com/docs/guides/function-calling?timeout=30#function-tool-example)
*   [Defining functions](http://platform.openai.com/docs/guides/function-calling?timeout=30#defining-functions)
*   [Handling function calls](http://platform.openai.com/docs/guides/function-calling?timeout=30#handling-function-calls)
*   [Additional configs](http://platform.openai.com/docs/guides/function-calling?timeout=30#additional-configurations)
*   [Streaming](http://platform.openai.com/docs/guides/function-calling?timeout=30#streaming)
*   [Custom tools](http://platform.openai.com/docs/guides/function-calling?timeout=30#custom-tools)
*   [Context-free grammars](http://platform.openai.com/docs/guides/function-calling?timeout=30#context-free-grammars)
