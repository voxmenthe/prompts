...
![Image 1: Computer use diagram](https://cdn.openai.com/API/docs/images/cua_diagram.png)
...
*   [Overview](http://platform.openai.com/docs/guides/tools-computer-use?timeout=30#page-top)
*   [How it works](http://platform.openai.com/docs/guides/tools-computer-use?timeout=30#how-it-works)
*   [Setting up your environment](http://platform.openai.com/docs/guides/tools-computer-use?timeout=30#setting-up-your-environment)
*   [Integrating the CUA loop](http://platform.openai.com/docs/guides/tools-computer-use?timeout=30#integration)
*   [Limitations](http://platform.openai.com/docs/guides/tools-computer-use?timeout=30#limitations)
*   [Risks and safety](http://platform.openai.com/docs/guides/tools-computer-use?timeout=30#risks-and-safety)
