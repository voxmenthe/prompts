...
[Supervised fine-tuning Fine-tune a model by providing correct outputs for sample inputs.](https://platform.openai.com/docs/guides/supervised-fine-tuning)[Vision fine-tuning Learn to fine-tune for computer vision with image inputs.](https://platform.openai.com/docs/guides/vision-fine-tuning)[Reinforcement fine-tuning Fine-tune a reasoning model by grading its outputs.](https://platform.openai.com/docs/guides/reinforcement-fine-tuning)

*   [Overview](http://platform.openai.com/docs/guides/direct-preference-optimization?timeout=30#page-top)
*   [Data format](http://platform.openai.com/docs/guides/direct-preference-optimization?timeout=30#data-format)
*   [Create a fine-tune job](http://platform.openai.com/docs/guides/direct-preference-optimization?timeout=30#create-a-dpo-fine-tune-job)
*   [SFT and DPO together](http://platform.openai.com/docs/guides/direct-preference-optimization?timeout=30#use-sft-and-dpo-together)
*   [Safety checks](http://platform.openai.com/docs/guides/direct-preference-optimization?timeout=30#safety-checks)
*   [Next steps](http://platform.openai.com/docs/guides/direct-preference-optimization?timeout=30#next-steps)
