...
*   [Overview](http://platform.openai.com/docs/guides/embeddings?timeout=30#what-are-embeddings)
*   [Models](http://platform.openai.com/docs/guides/embeddings?timeout=30#embedding-models)
*   [Use cases](http://platform.openai.com/docs/guides/embeddings?timeout=30#use-cases)
*   [FAQ](http://platform.openai.com/docs/guides/embeddings?timeout=30#faq)
