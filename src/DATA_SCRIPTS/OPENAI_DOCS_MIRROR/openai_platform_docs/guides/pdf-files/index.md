...
[Experiment with PDF inputs in the Playground Use the Playground to develop and iterate on prompts with PDF inputs.](https://platform.openai.com/chat/edit)[Full API reference Check out the API reference for more options.](https://platform.openai.com/docs/api-reference/responses)

Responses

*   [How it works](http://platform.openai.com/docs/guides/pdf-files?timeout=30#page-top)
*   [File URLs](http://platform.openai.com/docs/guides/pdf-files?timeout=30#file-urls)
*   [Uploading files](http://platform.openai.com/docs/guides/pdf-files?timeout=30#uploading-files)
*   [Base64-encoded files](http://platform.openai.com/docs/guides/pdf-files?timeout=30#base64-encoded-files)
*   [Usage considerations](http://platform.openai.com/docs/guides/pdf-files?timeout=30#usage-considerations)
*   [Next steps](http://platform.openai.com/docs/guides/pdf-files?timeout=30#next-steps)
