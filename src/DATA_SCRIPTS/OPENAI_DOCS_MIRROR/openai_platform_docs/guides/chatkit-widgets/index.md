...
![Image 1: widgets](https://cdn.openai.com/API/images/widget-graphic.png)
...
Learn more in the [actions docs](https://platform.openai.com/docs/guides/chatkit-actions).
...
*   [Overview](http://platform.openai.com/docs/guides/chatkit-widgets?timeout=30#page-top)
*   [Design widgets quickly](http://platform.openai.com/docs/guides/chatkit-widgets?timeout=30#design-widgets-quickly)
*   [Upload assets](http://platform.openai.com/docs/guides/chatkit-widgets?timeout=30#upload-assets)
*   [Handle actions](http://platform.openai.com/docs/guides/chatkit-widgets?timeout=30#handle-actions-on-your-server)
*   [Reference](http://platform.openai.com/docs/guides/chatkit-widgets?timeout=30#reference)
