...
*   Your OpenAI organization must be in [usage tier 1](https://platform.openai.com/docs/guides/rate-limits/usage-tiers#usage-tiers) or higher.
...
*   An endpoint compatible with [OpenAI’s chat completions endpoint](https://platform.openai.com/docs/api-reference/chat/create)
*   An API key
...
[Getting started with evals Uses Datasets to quickly build evals and interate on prompts.](https://platform.openai.com/docs/guides/evaluation-getting-started)[Working with evals Evaluate against external models, interact with evals via API, and more.](https://platform.openai.com/docs/guides/evals)
