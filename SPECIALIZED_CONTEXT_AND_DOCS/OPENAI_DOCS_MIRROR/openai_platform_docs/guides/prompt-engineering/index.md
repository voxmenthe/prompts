...
[GPT-5 prompting guide Get the most out of prompting GPT-5 with the tips and tricks in this prompting guide, extracted from real-world use cases and practical experience.](https://cookbook.openai.com/examples/gpt-5/gpt-5_prompting_guide)
...
*   [Overview](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#page-top)
*   [Message roles and instruction following](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#message-roles-and-instruction-following)
*   [Reusable prompts](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#reusable-prompts)
*   [Message formatting](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#message-formatting-with-markdown-and-xml)
*   [Few-shot learning](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#few-shot-learning)
*   [Include relevant context](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#include-relevant-context-information)
*   [Prompt GPT-5 models](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#prompting-gpt-5-models)
*   [Prompt reasoning models](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#prompting-reasoning-models)
*   [Next steps](http://platform.openai.com/docs/guides/prompt-engineering?timeout=30#next-steps)
