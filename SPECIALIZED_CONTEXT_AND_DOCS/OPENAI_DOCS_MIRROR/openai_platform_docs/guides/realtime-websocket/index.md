...
![Image 1: connect directly to realtime API](https://openaidevs.retool.com/api/file/464d4334-c467-4862-901b-d0c6847f003a)
...
*   [Overview](http://platform.openai.com/docs/guides/realtime-websocket?timeout=30#overview)
*   [Connect via WebSocket](http://platform.openai.com/docs/guides/realtime-websocket?timeout=30#connect-via-websocket)
*   [Send and receive events](http://platform.openai.com/docs/guides/realtime-websocket?timeout=30#sending-and-receiving-events)
