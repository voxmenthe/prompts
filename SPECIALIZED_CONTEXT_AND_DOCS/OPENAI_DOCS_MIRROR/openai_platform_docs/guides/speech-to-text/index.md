...
*   [Overview](http://platform.openai.com/docs/guides/speech-to-text?timeout=30#overview)
*   [Quickstart](http://platform.openai.com/docs/guides/speech-to-text?timeout=30#quickstart)
*   [Supported languages](http://platform.openai.com/docs/guides/speech-to-text?timeout=30#supported-languages)
*   [Timestamps](http://platform.openai.com/docs/guides/speech-to-text?timeout=30#timestamps)
*   [Longer inputs](http://platform.openai.com/docs/guides/speech-to-text?timeout=30#longer-inputs)
*   [Prompting](http://platform.openai.com/docs/guides/speech-to-text?timeout=30#prompting)
*   [Streaming transcriptions](http://platform.openai.com/docs/guides/speech-to-text?timeout=30#streaming)
*   [Improving reliability](http://platform.openai.com/docs/guides/speech-to-text?timeout=30#improving-reliability)
