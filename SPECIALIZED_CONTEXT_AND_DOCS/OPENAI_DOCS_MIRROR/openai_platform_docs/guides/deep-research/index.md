...
[Build a deep research compatible remote MCP server Give deep research models access to private data via remote Model Context Protocol (MCP) servers.](https://platform.openai.com/docs/mcp)
### Supported tools
...
*   [Overview](http://platform.openai.com/docs/guides/deep-research?timeout=30#page-top)
*   [Prompting deep research models](http://platform.openai.com/docs/guides/deep-research?timeout=30#prompting-deep-research-models)
*   [Research with your own data](http://platform.openai.com/docs/guides/deep-research?timeout=30#research-with-your-own-data)
*   [Safety risks and mitigations](http://platform.openai.com/docs/guides/deep-research?timeout=30#safety-risks-and-mitigations)
