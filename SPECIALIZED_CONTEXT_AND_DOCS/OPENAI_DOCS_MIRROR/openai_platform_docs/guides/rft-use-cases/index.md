...
*   [Overview](http://platform.openai.com/docs/guides/rft-use-cases?timeout=30#top)
*   [When to use reinforcement fine-tuning](http://platform.openai.com/docs/guides/rft-use-cases?timeout=30#when-to-use-reinforcement-fine-tuning)
*   [Evals are the foundation](http://platform.openai.com/docs/guides/rft-use-cases?timeout=30#evals-are-the-foundation)
*   [How to get better results from RFT](http://platform.openai.com/docs/guides/rft-use-cases?timeout=30#how-to-get-better-results-from-rft)
*   [Other resources](http://platform.openai.com/docs/guides/rft-use-cases?timeout=30#other-resources)
