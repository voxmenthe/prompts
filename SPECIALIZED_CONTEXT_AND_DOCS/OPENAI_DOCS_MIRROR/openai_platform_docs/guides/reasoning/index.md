...
![Image 1: Reasoning tokens aren't retained in context](https://cdn.openai.com/API/docs/images/context-window.png)
...
[Using reasoning for data validation Evaluate a synthetic medical data set for discrepancies.](https://cookbook.openai.com/examples/o1/using_reasoning_for_data_validation)[Using reasoning for routine generation Use help center articles to generate actions that an agent could perform.](https://cookbook.openai.com/examples/o1/using_reasoning_for_routine_generation)

*   [Get started](http://platform.openai.com/docs/guides/reasoning?timeout=30#get-started-with-reasoning)
*   [How reasoning works](http://platform.openai.com/docs/guides/reasoning?timeout=30#how-reasoning-works)
*   [Reasoning summaries](http://platform.openai.com/docs/guides/reasoning?timeout=30#reasoning-summaries)
*   [Advice on prompting](http://platform.openai.com/docs/guides/reasoning?timeout=30#advice-on-prompting)
*   [Use case examples](http://platform.openai.com/docs/guides/reasoning?timeout=30#use-case-examples)
