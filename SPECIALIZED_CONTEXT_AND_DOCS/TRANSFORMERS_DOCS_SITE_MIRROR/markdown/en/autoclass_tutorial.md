...
Load a tokenizer with [AutoTokenizer.from\_pretrained()](/docs/transformers/main/en/model_doc/auto#transformers.AutoTokenizer.from_pretrained):
...
![](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/Swin%20Stages.png) 

A Swin backbone with multiple stages for outputting a feature map.

The [AutoBackbone](/docs/transformers/main/en/main_classes/backbones#transformers.AutoBackbone) lets you use pretrained models as backbones to get feature maps from different stages of the backbone. You should specify one of the following parameters in [from\_pretrained()](/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained):
...
Load a feature extractor with [AutoFeatureExtractor.from\_pretrained()](/docs/transformers/main/en/model_doc/auto#transformers.AutoFeatureExtractor.from_pretrained):
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/autoclass_tutorial.md)
