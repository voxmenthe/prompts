...
[Trainer](/docs/transformers/main/en/main_classes/trainer#transformers.Trainer) supports AMP training with CPU by adding the `--use_cpu`, and `--bf16` parameters. The example below demonstrates the [run_qa.py](https://github.com/huggingface/transformers/tree/main/examples/pytorch/question-answering) script.
...
These parameters can also be added to [TrainingArguments](/docs/transformers/main/en/main_classes/trainer#transformers.TrainingArguments) as shown below.
