...
A basic convolution without padding or stride, taken from [A guide to convolution arithmetic for deep learning.](https://huggingface.co/papers/1603.07285)
...
![](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/convnext_architecture.png)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/tasks_explained.md)
