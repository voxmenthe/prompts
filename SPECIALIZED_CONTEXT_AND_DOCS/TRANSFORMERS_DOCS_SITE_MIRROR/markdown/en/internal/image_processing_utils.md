...
( image: ndarray size: tuple resample: typing.Optional[ForwardRef('PILImageResampling')] = None reducing\_gap: typing.Optional[int] = None data\_format: typing.Optional[transformers.image\_utils.ChannelDimension] = None return\_numpy: bool = True input\_data\_format: typing.Union[transformers.image\_utils.ChannelDimension, str, NoneType] = None  ) → `np.ndarray`
...
( image: typing.Union[numpy.ndarray, ForwardRef('PIL.Image.Image'), ForwardRef('torch.Tensor')] do\_rescale: typing.Optional[bool] = None image\_mode: typing.Optional[str] = None input\_data\_format: typing.Union[transformers.image\_utils.ChannelDimension, str, NoneType] = None  ) → `PIL.Image.Image`
...
#### fetch\_images
 ...
 [< source >](https://github.com/huggingface/transformers/blob/main/src/transformers/image_processing_base.py#L475)
...
( image\_processor\_dict: dict \*\*kwargs  ) → [ImageProcessingMixin](/docs/transformers/main/en/main_classes/image_processor#transformers.ImageProcessingMixin)
...
* **image\_processor\_dict** (`dict[str, Any]`) —
  ...
  [to\_dict()](/docs/transformers/main/en/internal/image_processing_utils#transformers.ImageProcessingMixin.to_dict) method.
* **kwargs** (`dict[str, Any]`) —
...
( json\_file: typing.Union[str, os.PathLike]  ) → A image processor of type [ImageProcessingMixin](/docs/transformers/main/en/main_classes/image_processor#transformers.ImageProcessingMixin)
