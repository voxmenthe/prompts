...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/squeezebert/configuration_squeezebert.py#L24)

This is the configuration class to store the configuration of a [SqueezeBertModel](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertModel). It is used to instantiate a
...
vocab_size (`int`, *optional*, defaults to 30522) : Vocabulary size of the SqueezeBERT model. Defines the number of different tokens that can be represented by the `inputs_ids` passed when calling [SqueezeBertModel](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertModel).
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/squeezebert/modeling_squeezebert.py#L418)
...
elements depending on the configuration ([SqueezeBertConfig](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertConfig)) and inputs.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  heads.
The [SqueezeBertModel](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/squeezebert/modeling_squeezebert.py#L498)
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [SqueezeBertForMaskedLM](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/squeezebert/modeling_squeezebert.py#L579)
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [SqueezeBertForSequenceClassification](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/squeezebert/modeling_squeezebert.py#L666)
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [SqueezeBertForMultipleChoice](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/squeezebert/modeling_squeezebert.py#L769)
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [SqueezeBertForTokenClassification](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/squeezebert/modeling_squeezebert.py#L835)
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [SqueezeBertForQuestionAnswering](/docs/transformers/main/en/model_doc/squeezebert#transformers.SqueezeBertForQuestionAnswering) forward method, overrides the `__call__` special method.
