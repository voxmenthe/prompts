...
## NezhaConfig[[transformers.NezhaConfig]]

#### transformers.NezhaConfig[[transformers.NezhaConfig]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/configuration_nezha.py#L4)

This is the configuration class to store the configuration of an [NezhaModel](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaModel). It is used to instantiate an Nezha
...
vocab_size (`int`, optional, defaults to 21128) : Vocabulary size of the NEZHA model. Defines the different tokens that can be represented by the *inputs_ids* passed to the forward method of [NezhaModel](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaModel).
...
type_vocab_size (`int`, optional, defaults to 2) : The vocabulary size of the *token_type_ids* passed into [NezhaModel](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaModel).
...
## NezhaModel[[transformers.NezhaModel]]

#### transformers.NezhaModel[[transformers.NezhaModel]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L684)
...
elements depending on the configuration ([NezhaConfig](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaConfig)) and inputs.
...
The [NezhaModel](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaModel) forward method, overrides the `__call__` special method.
...
config ([NezhaConfig](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
## NezhaForPreTraining[[transformers.NezhaForPreTraining]]

#### transformers.NezhaForPreTraining[[transformers.NezhaForPreTraining]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L855)
...
- **kwargs** (`dict[str, any]`, optional, defaults to *{}*) --
  Used to hide legacy arguments that have been deprecated.0`transformers.models.deprecated.nezha.modeling_nezha.NezhaForPreTrainingOutput` or `tuple(torch.FloatTensor)`A `transformers.models.deprecated.nezha.modeling_nezha.NezhaForPreTrainingOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([NezhaConfig](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaConfig)) and inputs.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [NezhaForPreTraining](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaForPreTraining) forward method, overrides the `__call__` special method.
...
A `transformers.models.deprecated.nezha.modeling_nezha.NezhaForPreTrainingOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([NezhaConfig](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaConfig)) and inputs.
...
## NezhaForMaskedLM[[transformers.NezhaForMaskedLM]]

#### transformers.NezhaForMaskedLM[[transformers.NezhaForMaskedLM]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L959)
...
forwardtransformers.NezhaForMaskedLM.forwardhttps://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L987[{"name": "input_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "token_type_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "inputs_embeds", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "encoder_hidden_states", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "encoder_attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "labels", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "output_attentions", "val": ": typing.Optional[bool] = None"}, {"name": "output_hidden_states", "val": ": typing.Optional[bool] = None"}, {"name": "return_dict", "val": ": typing.Optional[bool] = None"}]- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [NezhaForMaskedLM](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaForMaskedLM) forward method, overrides the `__call__` special method.
...
## NezhaForNextSentencePrediction[[transformers.NezhaForNextSentencePrediction]]

#### transformers.NezhaForNextSentencePrediction[[transformers.NezhaForNextSentencePrediction]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1067)
...
forwardtransformers.NezhaForNextSentencePrediction.forwardhttps://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1077[{"name": "input_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "token_type_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "inputs_embeds", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "labels", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "output_attentions", "val": ": typing.Optional[bool] = None"}, {"name": "output_hidden_states", "val": ": typing.Optional[bool] = None"}, {"name": "return_dict", "val": ": typing.Optional[bool] = None"}, {"name": "**kwargs", "val": ""}]- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [NezhaForNextSentencePrediction](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
## NezhaForSequenceClassification[[transformers.NezhaForSequenceClassification]]

#### transformers.NezhaForSequenceClassification[[transformers.NezhaForSequenceClassification]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1168)
...
forwardtransformers.NezhaForSequenceClassification.forwardhttps://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1184[{"name": "input_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "token_type_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "inputs_embeds", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "labels", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "output_attentions", "val": ": typing.Optional[bool] = None"}, {"name": "output_hidden_states", "val": ": typing.Optional[bool] = None"}, {"name": "return_dict", "val": ": typing.Optional[bool] = None"}]- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [NezhaForSequenceClassification](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaForSequenceClassification) forward method, overrides the `__call__` special method.
...
## NezhaForMultipleChoice[[transformers.NezhaForMultipleChoice]]

#### transformers.NezhaForMultipleChoice[[transformers.NezhaForMultipleChoice]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1265)
...
forwardtransformers.NezhaForMultipleChoice.forwardhttps://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1279[{"name": "input_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "token_type_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "inputs_embeds", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "labels", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "output_attentions", "val": ": typing.Optional[bool] = None"}, {"name": "output_hidden_states", "val": ": typing.Optional[bool] = None"}, {"name": "return_dict", "val": ": typing.Optional[bool] = None"}]- **input_ids** (`torch.LongTensor` of shape `(batch_size, num_choices, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [NezhaForMultipleChoice](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaForMultipleChoice) forward method, overrides the `__call__` special method.
...
## NezhaForTokenClassification[[transformers.NezhaForTokenClassification]]

#### transformers.NezhaForTokenClassification[[transformers.NezhaForTokenClassification]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1355)
...
forwardtransformers.NezhaForTokenClassification.forwardhttps://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1370[{"name": "input_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "token_type_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "inputs_embeds", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "labels", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "output_attentions", "val": ": typing.Optional[bool] = None"}, {"name": "output_hidden_states", "val": ": typing.Optional[bool] = None"}, {"name": "return_dict", "val": ": typing.Optional[bool] = None"}]- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [NezhaForTokenClassification](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaForTokenClassification) forward method, overrides the `__call__` special method.
...
## NezhaForQuestionAnswering[[transformers.NezhaForQuestionAnswering]]

#### transformers.NezhaForQuestionAnswering[[transformers.NezhaForQuestionAnswering]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1432)
...
forwardtransformers.NezhaForQuestionAnswering.forwardhttps://github.com/huggingface/transformers/blob/main/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1443[{"name": "input_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "attention_mask", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "token_type_ids", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "inputs_embeds", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "start_positions", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "end_positions", "val": ": typing.Optional[torch.Tensor] = None"}, {"name": "output_attentions", "val": ": typing.Optional[bool] = None"}, {"name": "output_hidden_states", "val": ": typing.Optional[bool] = None"}, {"name": "return_dict", "val": ": typing.Optional[bool] = None"}]- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.
The [NezhaForQuestionAnswering](/docs/transformers/main/en/model_doc/nezha#transformers.NezhaForQuestionAnswering) forward method, overrides the `__call__` special method.
