...
### class transformers.KerasMetricCallback
 ...
 [< source >](https://github.com/huggingface/transformers/blob/main/src/transformers/keras_callbacks.py#L20)
...
### class transformers.PushToHubCallback
 ...
 [< source >](https://github.com/huggingface/transformers/blob/main/src/transformers/keras_callbacks.py#L268)
...
* **save\_strategy** (`str` or [IntervalStrategy](/docs/transformers/main/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"epoch"`) —
