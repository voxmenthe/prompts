...
[Trainer](/docs/transformers/main/en/main_classes/trainer#transformers.Trainer) supports distributed training with CPUs with the oneCCL backend. Add the `--ddp_backend ccl` parameter in the command arguments to enable it.
