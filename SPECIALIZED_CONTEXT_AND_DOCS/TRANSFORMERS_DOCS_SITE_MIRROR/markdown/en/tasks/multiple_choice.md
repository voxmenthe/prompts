...
You're ready to start training your model now! Load BERT with [AutoModelForMultipleChoice](/docs/transformers/main/en/model_doc/auto#transformers.AutoModelForMultipleChoice):
