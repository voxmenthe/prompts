...
using the `output` property on [`generateText`](../reference/ai-sdk-core/generate-text.md)
and [`streamText`](../reference/ai-sdk-core/stream-text.md).
...
You can consume the structured output on the client with the [`useObject`](../reference/ai-sdk-ui/use-object.md) hook.
...
For more advanced validation or different structures, see [the Output API reference](../reference/ai-sdk-core/output.md).
...
When `generateText` with structured output cannot generate a valid object, it throws a [`AI_NoObjectGeneratedError`](../reference/ai-sdk-errors/ai-no-object-generated-error.md).
