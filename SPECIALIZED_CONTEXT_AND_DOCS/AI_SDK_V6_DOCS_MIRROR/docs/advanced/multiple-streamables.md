...
The client side code is similar to the previous example, but the [tool call](../ai-sdk-core/tools-and-tool-calling.md) will return the new data structure with the weather and forecast UIs. Depending on the speed of getting weather and forecast data, these two components might be updated independently.
