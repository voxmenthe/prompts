...
The [`useObject`](../reference/ai-sdk-ui/use-object.md) hook allows you to create interfaces that represent a structured JSON object that is being streamed.
...
The client uses [`useObject`](../reference/ai-sdk-ui/use-object.md) to stream the object generation process.
