This is a straight copy of the OpenAI API documentation from their website here: https://platform.openai.com/docs/api-reference/introduction
...
curl https://api.openai.com/v1/models \
  ...
  -H "OpenAI-Organization: org-0APx6gMGjKVHqRWgbYOFS8SL" \
