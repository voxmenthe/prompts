...
```
[#__codelineno-0-1](#__codelineno-0-1)$ uv export --format requirements.txt
[#__codelineno-0-2](#__codelineno-0-2)$ uv export --format pylock.toml
[#__codelineno-0-3](#__codelineno-0-3)$ uv export --format cyclonedx1.5
...
!!! tip "Tip"
    ...
    ```
[#__codelineno-1-1](#__codelineno-1-1)$ uv export --format requirements.txt --output-file requirements.txt
[#__codelineno-1-2](#__codelineno-1-2)$ uv export --format pylock.toml --output-file pylock.toml
[#__codelineno-1-3](#__codelineno-1-3)$ uv export --format cyclonedx1.5 --output-file sbom.json
...
```
[#__codelineno-2-1](#__codelineno-2-1)$ uv export --format requirements.txt
...
```
[#__codelineno-3-1](#__codelineno-3-1)$ uv export --format pylock.toml
...
```
[#__codelineno-4-1](#__codelineno-4-1)$ uv export --format cyclonedx1.5
