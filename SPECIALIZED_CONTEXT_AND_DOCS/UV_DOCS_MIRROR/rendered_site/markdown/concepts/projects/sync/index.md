...
```
[#__codelineno-7-1](#__codelineno-7-1)$ uv sync --extra foo
...
```
[#__codelineno-8-1](#__codelineno-8-1)$ uv sync --no-group foo --group foo
...
```
[#__codelineno-9-1](#__codelineno-9-1)$ uv lock --upgrade
...
```
[#__codelineno-10-1](#__codelineno-10-1)$ uv lock --upgrade-package 
