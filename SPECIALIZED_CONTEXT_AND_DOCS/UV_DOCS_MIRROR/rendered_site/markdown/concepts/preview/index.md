...
```
[#__codelineno-0-1](#__codelineno-0-1)$ uv run --preview ...
...
```
[#__codelineno-1-1](#__codelineno-1-1)$ UV_PREVIEW=1 uv run ...
...
```
[#__codelineno-2-1](#__codelineno-2-1)$ uv run --preview-features foo ...
...
```
[#__codelineno-3-1](#__codelineno-3-1)$ uv run --preview-features foo --preview-features bar ...
...
```
[#__codelineno-4-1](#__codelineno-4-1)$ uv run --preview-features foo,bar ...
...
```
[#__codelineno-5-1](#__codelineno-5-1)$ UV_PREVIEW_FEATURES=foo,bar uv run ...
