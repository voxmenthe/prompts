...
```
[#__codelineno-0-1](#__codelineno-0-1)# /// script
[#__codelineno-0-2](#__codelineno-0-2)# requires-python = ">=3.12"
[#__codelineno-0-3](#__codelineno-0-3)# dependencies = [
[#__codelineno-0-4](#__codelineno-0-4)#   "pandas",
[#__codelineno-0-5](#__codelineno-0-5)#   "pyarrow",
[#__codelineno-0-6](#__codelineno-0-6)#   "s3fs",
[#__codelineno-0-7](#__codelineno-0-7)# ]
[#__codelineno-0-8](#__codelineno-0-8)# ///
[#__codelineno-0-9](#__codelineno-0-9)
[#__codelineno-0-10](#__codelineno-0-10)import pandas as pd
[#__codelineno-0-11](#__codelineno-0-11)
[#__codelineno-0-12](#__codelineno-0-12)df = pd.read_parquet(
[#__codelineno-0-13](#__codelineno-0-13)    "s3://coiled-data/uber/part.0.parquet",
[#__codelineno-0-14](#__codelineno-0-14)    storage_options={"anon": True},
[#__codelineno-0-15](#__codelineno-0-15))
[#__codelineno-0-16](#__codelineno-0-16)print(df.head())
...
```
[#__codelineno-1-1](#__codelineno-1-1)$ uv run process.py
...
```
[#__codelineno-2-1](#__codelineno-2-1)$ uvx coiled login
...
```
[#__codelineno-3-1](#__codelineno-3-1)# COILED container ghcr.io/astral-sh/uv:debian-slim
[#__codelineno-3-2](#__codelineno-3-2)# COILED region us-east-2
[#__codelineno-3-3](#__codelineno-3-3)
[#__codelineno-3-4](#__codelineno-3-4)# /// script
[#__codelineno-3-5](#__codelineno-3-5)# requires-python = ">=3.12"
[#__codelineno-3-6](#__codelineno-3-6)# dependencies = [
[#__codelineno-3-7](#__codelineno-3-7)#   "pandas",
[#__codelineno-3-8](#__codelineno-3-8)#   "pyarrow",
[#__codelineno-3-9](#__codelineno-3-9)#   "s3fs",
[#__codelineno-3-10](#__codelineno-3-10)# ]
[#__codelineno-3-11](#__codelineno-3-11)# ///
[#__codelineno-3-12](#__codelineno-3-12)
[#__codelineno-3-13](#__codelineno-3-13)import pandas as pd
[#__codelineno-3-14](#__codelineno-3-14)
[#__codelineno-3-15](#__codelineno-3-15)df = pd.read_parquet(
[#__codelineno-3-16](#__codelineno-3-16)    "s3://coiled-data/uber/part.0.parquet",
[#__codelineno-3-17](#__codelineno-3-17)    storage_options={"anon": True},
[#__codelineno-3-18](#__codelineno-3-18))
[#__codelineno-3-19](#__codelineno-3-19)print(df.head())
...
```
[#__codelineno-4-1](#__codelineno-4-1)$ uvx coiled batch run \
[#__codelineno-4-2](#__codelineno-4-2)    uv run process.py
