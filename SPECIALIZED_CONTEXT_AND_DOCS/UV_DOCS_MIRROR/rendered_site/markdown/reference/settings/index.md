...
```
[#__codelineno-31-1](#__codelineno-31-1)[tool.uv]
[#__codelineno-31-2](#__codelineno-31-2)cache-dir = "./.uv_cache"
...
```
[#__codelineno-32-1](#__codelineno-32-1)cache-dir = "./.uv_cache"
...
```
[#__codelineno-33-1](#__codelineno-33-1)cache-keys = [{ file = "pyproject.toml" }, { file = "setup.py" }, { file = "setup.cfg" }, { dir = "src" }]
...
```
[#__codelineno-34-1](#__codelineno-34-1)[tool.uv]
[#__codelineno-34-2](#__codelineno-34-2)cache-keys = [{ file = "pyproject.toml" }, { file = "requirements.txt" }, { git = { commit = true } }]
...
```
[#__codelineno-35-1](#__codelineno-35-1)cache-keys = [{ file = "pyproject.toml" }, { file = "requirements.txt" }, { git = { commit = true } }]
...
```
[#__codelineno-36-1](#__codelineno-36-1)[tool.uv]
[#__codelineno-36-2](#__codelineno-36-2)check-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-37-1](#__codelineno-37-1)check-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-38-1](#__codelineno-38-1)[tool.uv]
[#__codelineno-38-2](#__codelineno-38-2)compile-bytecode = true
...
```
[#__codelineno-39-1](#__codelineno-39-1)compile-bytecode = true
...
```
[#__codelineno-40-1](#__codelineno-40-1)[tool.uv]
[#__codelineno-40-2](#__codelineno-40-2)concurrent-builds = 4
...
```
[#__codelineno-41-1](#__codelineno-41-1)concurrent-builds = 4
...
```
[#__codelineno-42-1](#__codelineno-42-1)[tool.uv]
[#__codelineno-42-2](#__codelineno-42-2)concurrent-downloads = 4
...
```
[#__codelineno-43-1](#__codelineno-43-1)concurrent-downloads = 4
...
```
[#__codelineno-44-1](#__codelineno-44-1)[tool.uv]
[#__codelineno-44-2](#__codelineno-44-2)concurrent-installs = 4
...
```
[#__codelineno-45-1](#__codelineno-45-1)concurrent-installs = 4
...
```
[#__codelineno-46-1](#__codelineno-46-1)[tool.uv]
[#__codelineno-46-2](#__codelineno-46-2)config-settings = { editable_mode = "compat" }
...
```
[#__codelineno-47-1](#__codelineno-47-1)config-settings = { editable_mode = "compat" }
...
```
[#__codelineno-48-1](#__codelineno-48-1)[tool.uv]
[#__codelineno-48-2](#__codelineno-48-2)config-settings-package = { numpy = { editable_mode = "compat" } }
...
```
[#__codelineno-49-1](#__codelineno-49-1)config-settings-package = { numpy = { editable_mode = "compat" } }
...
[#__codelineno-50-2](#__codelineno-50-2)dependency-metadata = [
[#__codelineno-50-3](#__codelineno-50-3)    { name = "flask", version = "1.0.0", requires-dist = ["werkzeug"], requires-python = ">=3.6" },
...
```
[#__codelineno-51-1](#__codelineno-51-1)dependency-metadata = [
[#__codelineno-51-2](#__codelineno-51-2)    { name = "flask", version = "1.0.0", requires-dist = ["werkzeug"], requires-python = ">=3.6" },
[#__codelineno-51-3](#__codelineno-51-3)]
...
[#__codelineno-52-2](#__codelineno-52-2)exclude-newer = "2006-12-02T02:07:43Z"
...
```
[#__codelineno-53-1](#__codelineno-53-1)exclude-newer = "2006-12-02T02:07:43Z"
...
```
[#__codelineno-54-1](#__codelineno-54-1)[tool.uv]
[#__codelineno-54-2](#__codelineno-54-2)exclude-newer-package = { tqdm = "2022-04-04T00:00:00Z" }
...
```
[#__codelineno-55-1](#__codelineno-55-1)exclude-newer-package = { tqdm = "2022-04-04T00:00:00Z" }
...
```
[#__codelineno-56-1](#__codelineno-56-1)[tool.uv]
[#__codelineno-56-2](#__codelineno-56-2)extra-build-dependencies = { pytest = ["setuptools"] }
...
```
[#__codelineno-57-1](#__codelineno-57-1)extra-build-dependencies = { pytest = ["setuptools"] }
...
```
[#__codelineno-58-1](#__codelineno-58-1)[tool.uv]
[#__codelineno-58-2](#__codelineno-58-2)extra-build-variables = { flash-attn = { FLASH_ATTENTION_SKIP_CUDA_BUILD = "TRUE" } }
...
```
[#__codelineno-59-1](#__codelineno-59-1)extra-build-variables = { flash-attn = { FLASH_ATTENTION_SKIP_CUDA_BUILD = "TRUE" } }
...
```
[#__codelineno-60-1](#__codelineno-60-1)[tool.uv]
[#__codelineno-60-2](#__codelineno-60-2)extra-index-url = ["https://download.pytorch.org/whl/cpu"]
...
```
[#__codelineno-61-1](#__codelineno-61-1)extra-index-url = ["https://download.pytorch.org/whl/cpu"]
...
```
[#__codelineno-62-1](#__codelineno-62-1)[tool.uv]
[#__codelineno-62-2](#__codelineno-62-2)find-links = ["https://download.pytorch.org/whl/torch_stable.html"]
...
```
[#__codelineno-63-1](#__codelineno-63-1)find-links = ["https://download.pytorch.org/whl/torch_stable.html"]
...
```
[#__codelineno-64-1](#__codelineno-64-1)[tool.uv]
[#__codelineno-64-2](#__codelineno-64-2)fork-strategy = "fewest"
...
```
[#__codelineno-65-1](#__codelineno-65-1)fork-strategy = "fewest"
...
```
[#__codelineno-66-1](#__codelineno-66-1)[[tool.uv.index]]
[#__codelineno-66-2](#__codelineno-66-2)name = "pytorch"
[#__codelineno-66-3](#__codelineno-66-3)url = "https://download.pytorch.org/whl/cu121"
[#__codelineno-66-4](#__codelineno-66-4)explicit = true
[#__codelineno-66-5](#__codelineno-66-5)
[#__codelineno-66-6](#__codelineno-66-6)[tool.uv.sources]
[#__codelineno-66-7](#__codelineno-66-7)torch = { index = "pytorch" }
...
```
[#__codelineno-69-1](#__codelineno-69-1)[tool.uv]
[#__codelineno-69-2](#__codelineno-69-2)index-strategy = "unsafe-best-match"
...
```
[#__codelineno-70-1](#__codelineno-70-1)index-strategy = "unsafe-best-match"
...
```
[#__codelineno-71-1](#__codelineno-71-1)[tool.uv]
[#__codelineno-71-2](#__codelineno-71-2)index-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-72-1](#__codelineno-72-1)index-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-73-1](#__codelineno-73-1)[tool.uv]
[#__codelineno-73-2](#__codelineno-73-2)keyring-provider = "subprocess"
...
```
[#__codelineno-74-1](#__codelineno-74-1)keyring-provider = "subprocess"
...
```
[#__codelineno-75-1](#__codelineno-75-1)[tool.uv]
[#__codelineno-75-2](#__codelineno-75-2)link-mode = "copy"
...
```
[#__codelineno-76-1](#__codelineno-76-1)link-mode = "copy"
...
```
[#__codelineno-77-1](#__codelineno-77-1)[tool.uv]
[#__codelineno-77-2](#__codelineno-77-2)native-tls = true
...
```
[#__codelineno-95-1](#__codelineno-95-1)[tool.uv]
[#__codelineno-95-2](#__codelineno-95-2)no-sources = true
...
```
[#__codelineno-96-1](#__codelineno-96-1)no-sources = true
...
```
[#__codelineno-97-1](#__codelineno-97-1)[tool.uv]
[#__codelineno-97-2](#__codelineno-97-2)offline = true
...
```
[#__codelineno-98-1](#__codelineno-98-1)offline = true
...
```
[#__codelineno-99-1](#__codelineno-99-1)[tool.uv]
[#__codelineno-99-2](#__codelineno-99-2)prerelease = "allow"
...
```
[#__codelineno-100-1](#__codelineno-100-1)prerelease = "allow"
...
```
[#__codelineno-101-1](#__codelineno-101-1)[tool.uv]
[#__codelineno-101-2](#__codelineno-101-2)preview = true
...
```
[#__codelineno-102-1](#__codelineno-102-1)preview = true
...
```
[#__codelineno-103-1](#__codelineno-103-1)[tool.uv]
[#__codelineno-103-2](#__codelineno-103-2)publish-url = "https://test.pypi.org/legacy/"
...
```
[#__codelineno-104-1](#__codelineno-104-1)publish-url = "https://test.pypi.org/legacy/"
...
```
[#__codelineno-105-1](#__codelineno-105-1)[tool.uv]
[#__codelineno-105-2](#__codelineno-105-2)pypy-install-mirror = "https://downloads.python.org/pypy"
...
```
[#__codelineno-106-1](#__codelineno-106-1)pypy-install-mirror = "https://downloads.python.org/pypy"
...
```
[#__codelineno-107-1](#__codelineno-107-1)[tool.uv]
[#__codelineno-107-2](#__codelineno-107-2)python-downloads = "manual"
...
```
[#__codelineno-108-1](#__codelineno-108-1)python-downloads = "manual"
...
[#__codelineno-109-2](#__codelineno-109-2)python-downloads-json-url = "/etc/uv/python-downloads.json"
...
```
[#__codelineno-110-1](#__codelineno-110-1)python-downloads-json-url = "/etc/uv/python-downloads.json"
...
```
[#__codelineno-111-1](#__codelineno-111-1)[tool.uv]
[#__codelineno-111-2](#__codelineno-111-2)python-install-mirror = "https://github.com/astral-sh/python-build-standalone/releases/download"
...
[#__codelineno-123-2](#__codelineno-123-2)trusted-publishing = "always"
...
```
[#__codelineno-124-1](#__codelineno-124-1)trusted-publishing = "always"
...
[#__codelineno-125-2](#__codelineno-125-2)upgrade = true
...
```
[#__codelineno-126-1](#__codelineno-126-1)upgrade = true
...
[#__codelineno-127-2](#__codelineno-127-2)upgrade-package = ["ruff"]
...
```
[#__codelineno-128-1](#__codelineno-128-1)upgrade-package = ["ruff"]
...
```
[#__codelineno-129-1](#__codelineno-129-1)[tool.uv.pip]
[#__codelineno-129-2](#__codelineno-129-2)all-extras = true
...
```
[#__codelineno-130-1](#__codelineno-130-1)[pip]
[#__codelineno-130-2](#__codelineno-130-2)all-extras = true
...
[#__codelineno-131-2](#__codelineno-131-2)allow-empty-requirements = true
...
[#__codelineno-132-2](#__codelineno-132-2)allow-empty-requirements = true
...
[#__codelineno-133-2](#__codelineno-133-2)annotation-style = "line"
...
[#__codelineno-134-2](#__codelineno-134-2)annotation-style = "line"
...
[#__codelineno-135-2](#__codelineno-135-2)break-system-packages = true
...
[#__codelineno-136-2](#__codelineno-136-2)break-system-packages = true
...
[#__codelineno-137-2](#__codelineno-137-2)compile-bytecode = true
...
[#__codelineno-138-2](#__codelineno-138-2)compile-bytecode = true
...
[#__codelineno-139-2](#__codelineno-139-2)config-settings = { editable_mode = "compat" }
...
[#__codelineno-140-2](#__codelineno-140-2)config-settings = { editable_mode = "compat" }
...
[#__codelineno-141-2](#__codelineno-141-2)config-settings-package = { numpy = { editable_mode = "compat" } }
...
[#__codelineno-142-2](#__codelineno-142-2)config-settings-package = { numpy = { editable_mode = "compat" } }
...
[#__codelineno-143-2](#__codelineno-143-2)custom-compile-command = "./custom-uv-compile.sh"
...
[#__codelineno-144-2](#__codelineno-144-2)custom-compile-command = "./custom-uv-compile.sh"
...
[#__codelineno-145-2](#__codelineno-145-2)dependency-metadata = [
[#__codelineno-145-3](#__codelineno-145-3)    { name = "flask", version = "1.0.0", requires-dist = ["werkzeug"], requires-python = ">=3.6" },
[#__codelineno-145-4](#__codelineno-145-4)]
...
[#__codelineno-146-2](#__codelineno-146-2)dependency-metadata = [
[#__codelineno-146-3](#__codelineno-146-3)    { name = "flask", version = "1.0.0", requires-dist = ["werkzeug"], requires-python = ">=3.6" },
[#__codelineno-146-4](#__codelineno-146-4)]
...
[#__codelineno-147-2](#__codelineno-147-2)emit-build-options = true
...
[#__codelineno-148-2](#__codelineno-148-2)emit-build-options = true
...
[#__codelineno-149-2](#__codelineno-149-2)emit-find-links = true
...
[#__codelineno-150-2](#__codelineno-150-2)emit-find-links = true
...
[#__codelineno-151-2](#__codelineno-151-2)emit-index-annotation = true
...
[#__codelineno-152-2](#__codelineno-152-2)emit-index-annotation = true
...
[#__codelineno-153-2](#__codelineno-153-2)emit-index-url = true
...
[#__codelineno-154-2](#__codelineno-154-2)emit-index-url = true
...
[#__codelineno-155-2](#__codelineno-155-2)emit-marker-expression = true
...
[#__codelineno-156-2](#__codelineno-156-2)emit-marker-expression = true
...
[#__codelineno-157-2](#__codelineno-157-2)exclude-newer = "2006-12-02T02:07:43Z"
...
[#__codelineno-158-2](#__codelineno-158-2)exclude-newer = "2006-12-02T02:07:43Z"
...
[#__codelineno-159-2](#__codelineno-159-2)exclude-newer-package = { tqdm = "2022-04-04T00:00:00Z" }
...
[#__codelineno-160-2](#__codelineno-160-2)exclude-newer-package = { tqdm = "2022-04-04T00:00:00Z" }
...
[#__codelineno-161-2](#__codelineno-161-2)extra = ["dev", "docs"]
...
[#__codelineno-162-2](#__codelineno-162-2)extra = ["dev", "docs"]
...
[#__codelineno-163-2](#__codelineno-163-2)extra-build-dependencies = { pytest = ["setuptools"] }
...
[#__codelineno-164-2](#__codelineno-164-2)extra-build-dependencies = { pytest = ["setuptools"] }
...
[#__codelineno-165-2](#__codelineno-165-2)extra-build-variables = { flash-attn = { FLASH_ATTENTION_SKIP_CUDA_BUILD = "TRUE" } }
...
[#__codelineno-166-2](#__codelineno-166-2)extra-build-variables = { flash-attn = { FLASH_ATTENTION_SKIP_CUDA_BUILD = "TRUE" } }
...
[#__codelineno-167-2](#__codelineno-167-2)extra-index-url = ["https://download.pytorch.org/whl/cpu"]
...
[#__codelineno-168-2](#__codelineno-168-2)extra-index-url = ["https://download.pytorch.org/whl/cpu"]
...
[#__codelineno-169-2](#__codelineno-169-2)find-links = ["https://download.pytorch.org/whl/torch_stable.html"]
...
[#__codelineno-170-2](#__codelineno-170-2)find-links = ["https://download.pytorch.org/whl/torch_stable.html"]
...
[#__codelineno-171-2](#__codelineno-171-2)fork-strategy = "fewest"
...
[#__codelineno-172-2](#__codelineno-172-2)fork-strategy = "fewest"
...
[#__codelineno-173-2](#__codelineno-173-2)generate-hashes = true
...
[#__codelineno-174-2](#__codelineno-174-2)generate-hashes = true
...
[#__codelineno-175-2](#__codelineno-175-2)group = ["dev", "docs"]
...
[#__codelineno-176-2](#__codelineno-176-2)group = ["dev", "docs"]
...
[#__codelineno-177-2](#__codelineno-177-2)index-strategy = "unsafe-best-match"
...
[#__codelineno-178-2](#__codelineno-178-2)index-strategy = "unsafe-best-match"
...
[#__codelineno-179-2](#__codelineno-179-2)index-url = "https://test.pypi.org/simple"
...
[#__codelineno-180-2](#__codelineno-180-2)index-url = "https://test.pypi.org/simple"
...
[#__codelineno-181-2](#__codelineno-181-2)keyring-provider = "subprocess"
...
[#__codelineno-182-2](#__codelineno-182-2)keyring-provider = "subprocess"
...
[#__codelineno-183-2](#__codelineno-183-2)link-mode = "copy"
...
[#__codelineno-184-2](#__codelineno-184-2)link-mode = "copy"
...
[#__codelineno-185-2](#__codelineno-185-2)no-annotate = true
...
[#__codelineno-186-2](#__codelineno-186-2)no-annotate = true
...
[#__codelineno-187-2](#__codelineno-187-2)no-binary = ["ruff"]
...
[#__codelineno-188-2](#__codelineno-188-2)no-binary = ["ruff"]
...
[#__codelineno-189-2](#__codelineno-189-2)no-build = true
...
[#__codelineno-190-2](#__codelineno-190-2)no-build = true
...
[#__codelineno-191-2](#__codelineno-191-2)no-build-isolation = true
...
[#__codelineno-192-2](#__codelineno-192-2)no-build-isolation = true
...
[#__codelineno-193-2](#__codelineno-193-2)no-build-isolation-package = ["package1", "package2"]
...
[#__codelineno-194-2](#__codelineno-194-2)no-build-isolation-package = ["package1", "package2"]
...
[#__codelineno-195-2](#__codelineno-195-2)no-deps = true
...
[#__codelineno-196-2](#__codelineno-196-2)no-deps = true
...
[#__codelineno-197-2](#__codelineno-197-2)no-emit-package = ["ruff"]
...
[#__codelineno-198-2](#__codelineno-198-2)no-emit-package = ["ruff"]
...
[#__codelineno-199-2](#__codelineno-199-2)all-extras = true
[#__codelineno-199-3](#__codelineno-199-3)no-extra = ["dev", "docs"]
...
[#__codelineno-200-2](#__codelineno-200-2)all-extras = true
[#__codelineno-200-3](#__codelineno-200-3)no-extra = ["dev", "docs"]
...
[#__codelineno-201-2](#__codelineno-201-2)no-header = true
...
[#__codelineno-202-2](#__codelineno-202-2)no-header = true
...
[#__codelineno-203-2](#__codelineno-203-2)no-index = true
...
[#__codelineno-204-2](#__codelineno-204-2)no-index = true
...
[#__codelineno-205-2](#__codelineno-205-2)no-sources = true
...
[#__codelineno-206-2](#__codelineno-206-2)no-sources = true
...
[#__codelineno-207-2](#__codelineno-207-2)no-strip-extras = true
...
[#__codelineno-208-2](#__codelineno-208-2)no-strip-extras = true
...
[#__codelineno-209-2](#__codelineno-209-2)no-strip-markers = true
...
[#__codelineno-210-2](#__codelineno-210-2)no-strip-markers = true
...
[#__codelineno-211-2](#__codelineno-211-2)only-binary = ["ruff"]
...
[#__codelineno-212-2](#__codelineno-212-2)only-binary = ["ruff"]
...
[#__codelineno-213-2](#__codelineno-213-2)output-file = "requirements.txt"
...
[#__codelineno-214-2](#__codelineno-214-2)output-file = "requirements.txt"
...
[#__codelineno-215-2](#__codelineno-215-2)prefix = "./prefix"
...
[#__codelineno-216-2](#__codelineno-216-2)prefix = "./prefix"
...
[#__codelineno-217-2](#__codelineno-217-2)prerelease = "allow"
...
[#__codelineno-218-2](#__codelineno-218-2)prerelease = "allow"
...
[#__codelineno-219-2](#__codelineno-219-2)python = "3.10"
...
[#__codelineno-220-2](#__codelineno-220-2)python = "3.10"
...
[#__codelineno-221-2](#__codelineno-221-2)python-platform = "x86_64-unknown-linux-gnu"
...
[#__codelineno-222-2](#__codelineno-222-2)python-platform = "x86_64-unknown-linux-gnu"
...
[#__codelineno-223-2](#__codelineno-223-2)python-version = "3.8"
...
[#__codelineno-224-2](#__codelineno-224-2)python-version = "3.8"
...
[#__codelineno-225-2](#__codelineno-225-2)reinstall = true
...
[#__codelineno-226-2](#__codelineno-226-2)reinstall = true
...
[#__codelineno-227-2](#__codelineno-227-2)reinstall-package = ["ruff"]
...
[#__codelineno-228-2](#__codelineno-228-2)reinstall-package = ["ruff"]
...
[#__codelineno-229-2](#__codelineno-229-2)require-hashes = true
...
[#__codelineno-230-2](#__codelineno-230-2)require-hashes = true
...
[#__codelineno-231-2](#__codelineno-231-2)resolution = "lowest-direct"
...
[#__codelineno-232-2](#__codelineno-232-2)resolution = "lowest-direct"
...
[#__codelineno-233-2](#__codelineno-233-2)strict = true
...
[#__codelineno-234-2](#__codelineno-234-2)strict = true
...
[#__codelineno-235-2](#__codelineno-235-2)system = true
...
[#__codelineno-236-2](#__codelineno-236-2)system = true
...
[#__codelineno-237-2](#__codelineno-237-2)target = "./target"
...
[#__codelineno-238-2](#__codelineno-238-2)target = "./target"
...
[#__codelineno-239-2](#__codelineno-239-2)torch-backend = "auto"
...
[#__codelineno-240-2](#__codelineno-240-2)torch-backend = "auto"
...
[#__codelineno-241-2](#__codelineno-241-2)universal = true
...
[#__codelineno-242-2](#__codelineno-242-2)universal = true
...
[#__codelineno-243-2](#__codelineno-243-2)upgrade = true
...
[#__codelineno-244-2](#__codelineno-244-2)upgrade = true
...
[#__codelineno-245-2](#__codelineno-245-2)upgrade-package = ["ruff"]
...
[#__codelineno-246-2](#__codelineno-246-2)upgrade-package = ["ruff"]
...
[#__codelineno-247-2](#__codelineno-247-2)verify-hashes = true
...
[#__codelineno-248-2](#__codelineno-248-2)verify-hashes = true
