...
Please also see the [error handling](error-handling.md) guide for more information.
...
Track token consumption and resource usage with [message metadata](message-metadata.md):
