...
### class transformers.GPTNeoConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/configuration_gpt_neo.py#L30)
...
* **vocab\_size** (`int`, *optional*, defaults to 50257) —
  ...
  `inputs_ids` passed when calling [GPTNeoModel](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoModel). Vocabulary size of the model. Defines the different
  tokens that can be represented by the *inputs\_ids* passed to the forward method of [GPTNeoModel](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoModel).
...
* **attention\_types** (`List`, *optional*, defaults to `[[['global', 'local'], 12]]`) —
...
* **window\_size** (`int`, *optional*, defaults to 256) —
...
* **resid\_dropout** (`float`, *optional*, defaults to 0.0) —
  Residual dropout used in the attention pattern.
* **embed\_dropout** (`float`, *optional*, defaults to 0.0) —
  The dropout probability for all fully connected layers in the embeddings, encoder, and pooler.
* **attention\_dropout** (`float`, *optional*, defaults to 0.0) —
  The dropout ratio for the attention probabilities.
* **classifier\_dropout** (`float`, *optional*, defaults to 0.1) —
  Argument used when doing token classification, used in the model [GPTNeoForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForTokenClassification). The
...
This is the configuration class to store the configuration of a [GPTNeoModel](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoModel). It is used to instantiate a GPT
...
### class transformers.GPTNeoModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L503)

( config  )

Parameters

* **config** ([GPTNeoModel](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoModel)) —
...
* **past\_key\_values** (`Union[~cache_utils.Cache, tuple[torch.FloatTensor], NoneType]`) —
...
elements depending on the configuration ([GPTNeoConfig](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoConfig)) and inputs.
...
The [GPTNeoModel](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoModel) forward method, overrides the `__call__` special method.
...
### class transformers.GPTNeoForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L780)

( config  )

Parameters

* **config** ([GPTNeoForCausalLM](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L791)
...
The [GPTNeoForCausalLM](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.GPTNeoForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L1099)

( config  )

Parameters

* **config** ([GPTNeoForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForQuestionAnswering)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L1109)
...
The [GPTNeoForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### class transformers.GPTNeoForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L893)

( config  )

Parameters

* **config** ([GPTNeoForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForSequenceClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
[GPTNeoForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L903)
...
The [GPTNeoForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.GPTNeoForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L1014)

( config  )

Parameters

* **config** ([GPTNeoForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForTokenClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L1026)
...
The [GPTNeoForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/gpt_neo#transformers.GPTNeoForTokenClassification) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/gpt_neo.md)
