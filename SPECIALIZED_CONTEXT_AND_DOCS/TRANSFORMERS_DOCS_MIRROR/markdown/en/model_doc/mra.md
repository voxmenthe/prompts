...
### class transformers.MraConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/configuration_mra.py#L24)
...
* **vocab\_size** (`int`, *optional*, defaults to 50265) —
  ...
  `inputs_ids` passed when calling [MraModel](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraModel).
...
* **type\_vocab\_size** (`int`, *optional*, defaults to 1) —
  The vocabulary size of the `token_type_ids` passed when calling [MraModel](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraModel).
...
This is the configuration class to store the configuration of a [MraModel](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraModel). It is used to instantiate an MRA
...
### class transformers.MraModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L845)

( config  )

Parameters

* **config** ([MraModel](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraModel)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L870)
...
elements depending on the configuration ([MraConfig](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraConfig)) and inputs.
...
The [MraModel](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraModel) forward method, overrides the `__call__` special method.
...
### class transformers.MraForMaskedLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L949)

( config  )

Parameters

* **config** ([MraForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForMaskedLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L968)
...
The [MraForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForMaskedLM) forward method, overrides the `__call__` special method.
...
### class transformers.MraForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L1048)

( config  )

Parameters

* **config** ([MraForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForSequenceClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L1058)
...
The [MraForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.MraForMultipleChoice
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L1128)

( config  )

Parameters

* **config** ([MraForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForMultipleChoice)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L1139)
...
The [MraForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForMultipleChoice) forward method, overrides the `__call__` special method.
...
### class transformers.MraForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L1232)

( config  )

Parameters

* **config** ([MraForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForTokenClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L1244)
...
The [MraForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForTokenClassification) forward method, overrides the `__call__` special method.
...
### class transformers.MraForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L1306)

( config  )

Parameters

* **config** ([MraForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForQuestionAnswering)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mra/modeling_mra.py#L1319)
...
The [MraForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/mra#transformers.MraForQuestionAnswering) forward method, overrides the `__call__` special method.
