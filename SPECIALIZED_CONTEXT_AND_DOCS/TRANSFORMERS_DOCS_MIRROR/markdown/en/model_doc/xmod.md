...
### class transformers.XmodConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/configuration_xmod.py#L29)
...
* **vocab\_size** (`int`, *optional*, defaults to 30522) —
  ...
  `inputs_ids` passed when calling [XmodModel](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodModel).
...
* **type\_vocab\_size** (`int`, *optional*, defaults to 2) —
  The vocabulary size of the `token_type_ids` passed when calling [XmodModel](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodModel).
...
* **default\_language** (`str`, *optional*) —
...
This is the configuration class to store the configuration of a [XmodModel](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodModel). It is used to instantiate an X-MOD
...
### class transformers.XmodModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L687)

( config add\_pooling\_layer = True  )

Parameters

* **config** ([XmodModel](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodModel)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L722)
...
* **lang\_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) —
...
elements depending on the configuration ([XmodConfig](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodConfig)) and inputs.
...
The [XmodModel](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodModel) forward method, overrides the `__call__` special method.
...
### class transformers.XmodForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L860)

( config  )

Parameters

* **config** ([XmodForCausalLM](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L884)
...
The [XmodForCausalLM](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.XmodForMaskedLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L980)

( config  )

Parameters

* **config** ([XmodForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForMaskedLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1007)
...
The [XmodForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForMaskedLM) forward method, overrides the `__call__` special method.
...
### class transformers.XmodForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1107)

( config  )

Parameters

* **config** ([XmodForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForSequenceClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1120)
...
The [XmodForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.XmodForMultipleChoice
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1197)

( config  )

Parameters

* **config** ([XmodForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForMultipleChoice)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1209)
...
* **input\_ids** (`torch.LongTensor` of shape `(batch_size, num_choices, sequence_length)`) —
  ...
  [What are input IDs?](../glossary#input-ids)
* **lang\_ids** (`torch.LongTensor` of shape `(batch_size, num_choices, sequence_length)`, *optional*) —
  Indices of the language adapters that should be activated for each sample, respectively. Default: the index
  that corresponds to `self.config.default_language`.
...
The [XmodForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForMultipleChoice) forward method, overrides the `__call__` special method.
...
### class transformers.XmodForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1307)

( config  )

Parameters

* **config** ([XmodForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForTokenClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1323)
...
The [XmodForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForTokenClassification) forward method, overrides the `__call__` special method.
...
### class transformers.XmodForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1406)

( config  )

Parameters

* **config** ([XmodForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForQuestionAnswering)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/xmod/modeling_xmod.py#L1418)
...
The [XmodForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/xmod#transformers.XmodForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/xmod.md)
