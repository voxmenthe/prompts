...
### class transformers.Ernie4\_5Config

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/ernie4_5/configuration_ernie4_5.py#L20)

( vocab\_size = 103424 hidden\_size = 1024 intermediate\_size = 3072 num\_hidden\_layers = 18 num\_attention\_heads = 16 num\_key\_value\_heads = 2 hidden\_act = 'silu' max\_position\_embeddings = 131072 initializer\_range = 0.02 rms\_norm\_eps = 1e-05 use\_cache = True pad\_token\_id = 0 bos\_token\_id = 1 eos\_token\_id = 2 tie\_word\_embeddings = True rope\_theta = 500000.0 rope\_scaling = None use\_bias = False head\_dim = 128 \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 103424) —
  ...
  `inputs_ids` passed when calling [Ernie4\_5Model](/docs/transformers/v4.56.2/en/model_doc/ernie4_5#transformers.Ernie4_5Model)
...
This is the configuration class to store the configuration of a [Ernie4\_5Model](/docs/transformers/v4.56.2/en/model_doc/ernie4_5#transformers.Ernie4_5Model). It is used to instantiate an Ernie 4.5
...
### class transformers.Ernie4\_5Model

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/ernie4_5/modeling_ernie4_5.py#L328)

( config: Ernie4\_5Config  )

Parameters

* **config** ([Ernie4\_5Config](/docs/transformers/v4.56.2/en/model_doc/ernie4_5#transformers.Ernie4_5Config)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/ernie4_5/modeling_ernie4_5.py#L345)
...
elements depending on the configuration ([Ernie4\_5Config](/docs/transformers/v4.56.2/en/model_doc/ernie4_5#transformers.Ernie4_5Config)) and inputs.
...
The [Ernie4\_5Model](/docs/transformers/v4.56.2/en/model_doc/ernie4_5#transformers.Ernie4_5Model) forward method, overrides the `__call__` special method.

Although the recipe for forward pass needs to be defined within this function, one should call the `Module`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.

## Ernie4\_5ForCausalLM

### class transformers.Ernie4\_5ForCausalLM

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/ernie4_5/modeling_ernie4_5.py#L407)

( config  )

Parameters

* **config** ([Ernie4\_5ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/ernie4_5#transformers.Ernie4_5ForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/ernie4_5/modeling_ernie4_5.py#L421)
...
The [Ernie4\_5ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/ernie4_5#transformers.Ernie4_5ForCausalLM) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/ernie4_5.md)
