...
* SEWForCTC is fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded using
  [Wav2Vec2CTCTokenizer](/docs/transformers/v4.56.2/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer).
...
* **final\_dropout** (`float`, *optional*, defaults to 0.1) —
  The dropout probability for the final projection layer of [SEWForCTC](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWForCTC).
...
* **ctc\_loss\_reduction** (`str`, *optional*, defaults to `"sum"`) —
  ...
  instance of [SEWForCTC](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWForCTC).
* **ctc\_zero\_infinity** (`bool`, *optional*, defaults to `False`) —
  Whether to zero infinite losses and the associated gradients of `torch.nn.CTCLoss`. Infinite losses mainly
  occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
  of [SEWForCTC](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWForCTC).
...
This is the configuration class to store the configuration of a [SEWModel](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWModel). It is used to instantiate a SEW model
...
### class transformers.SEWModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/sew/modeling_sew.py#L702)

( config: SEWConfig  )

Parameters

* **config** ([SEWConfig](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWConfig)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/sew/modeling_sew.py#L769)
...
elements depending on the configuration ([SEWConfig](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWConfig)) and inputs.
...
The [SEWModel](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWModel) forward method, overrides the `__call__` special method.
...
### class transformers.SEWForCTC
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/sew/modeling_sew.py#L832)

( config target\_lang: typing.Optional[str] = None  )

Parameters

* **config** ([SEWForCTC](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWForCTC)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
* **target\_lang** (`str`, *optional*) —
  Language id of adapter weights. Adapter weights are stored in the format adapter..safetensors or
  adapter..bin. Only relevant when using an instance of [SEWForCTC](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWForCTC) with adapters. Uses ‘eng’ by
  default.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/sew/modeling_sew.py#L910)
...
The [SEWForCTC](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWForCTC) forward method, overrides the `__call__` special method.
...
### class transformers.SEWForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/sew/modeling_sew.py#L988)

( config  )

Parameters

* **config** ([SEWForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWForSequenceClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/sew/modeling_sew.py#L1033)
...
The [SEWForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/sew#transformers.SEWForSequenceClassification) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/sew.md)
