...
Note that [TapexTokenizer](/docs/transformers/v4.56.2/en/model_doc/tapex#transformers.TapexTokenizer) also supports batched inference. Hence, one can provide a batch of different tables/questions, or a batch of a single table
...
of a table), one can instantiate a [BartForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/bart#transformers.BartForSequenceClassification) model. TAPEX has checkpoints on the hub fine-tuned on TabFact, an important
...
### class transformers.TapexTokenizer
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/tapex/tokenization_tapex.py#L177)
...
* **max\_cell\_length** (`int`, *optional*, defaults to 15) —
...
* **padding** (`bool`, `str` or [PaddingStrategy](/docs/transformers/v4.56.2/en/internal/file_utils#transformers.utils.PaddingStrategy), *optional*, defaults to `False`) —
  ...
  + `False` or `'do_not_pad'` (default): No padding (i.e., can output a batch with sequences of different
    lengths).
* **truncation** (`bool`, `str`, `TapexTruncationStrategy` or [TruncationStrategy](/docs/transformers/v4.56.2/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy), —
...
#### save\_vocabulary
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/tapex/tokenization_tapex.py#L466)

( save\_directory: str filename\_prefix: typing.Optional[str] = None  )

[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/tapex.md)
