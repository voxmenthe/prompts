...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v4.56.2/en/main_classes/pipelines#transformers.Pipeline), [`AutoModel`, and from the command line.
...
### class transformers.GraniteConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granite/configuration_granite.py#L30)

( vocab\_size = 32000 hidden\_size = 4096 intermediate\_size = 11008 num\_hidden\_layers = 32 num\_attention\_heads = 32 num\_key\_value\_heads = None hidden\_act = 'silu' max\_position\_embeddings = 2048 initializer\_range = 0.02 rms\_norm\_eps = 1e-06 use\_cache = True pad\_token\_id = None bos\_token\_id = 1 eos\_token\_id = 2 tie\_word\_embeddings = False rope\_theta = 10000.0 rope\_scaling = None attention\_bias = False attention\_dropout = 0.0 mlp\_bias = False embedding\_multiplier = 1.0 logits\_scaling = 1.0 residual\_multiplier = 1.0 attention\_multiplier = 1.0 \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 32000) —
  ...
  `inputs_ids` passed when calling [GraniteModel](/docs/transformers/v4.56.2/en/model_doc/granite#transformers.GraniteModel)
...
This is the configuration class to store the configuration of a [GraniteModel](/docs/transformers/v4.56.2/en/model_doc/granite#transformers.GraniteModel). It is used to instantiate an Granite
...
### class transformers.GraniteModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granite/modeling_granite.py#L360)

( config: GraniteConfig  )

Parameters

* **config** ([GraniteConfig](/docs/transformers/v4.56.2/en/model_doc/granite#transformers.GraniteConfig)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granite/modeling_granite.py#L378)
...
elements depending on the configuration ([GraniteConfig](/docs/transformers/v4.56.2/en/model_doc/granite#transformers.GraniteConfig)) and inputs.
...
The [GraniteModel](/docs/transformers/v4.56.2/en/model_doc/granite#transformers.GraniteModel) forward method, overrides the `__call__` special method.
...
### class transformers.GraniteForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granite/modeling_granite.py#L479)

( config  )

Parameters

* **config** ([GraniteForCausalLM](/docs/transformers/v4.56.2/en/model_doc/granite#transformers.GraniteForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granite/modeling_granite.py#L493)
...
The [GraniteForCausalLM](/docs/transformers/v4.56.2/en/model_doc/granite#transformers.GraniteForCausalLM) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/granite.md)
