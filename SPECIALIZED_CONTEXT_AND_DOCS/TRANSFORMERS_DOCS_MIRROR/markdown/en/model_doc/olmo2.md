...
* Load specific intermediate checkpoints by adding the `revision` parameter to [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained).
...
### class transformers.Olmo2Config
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/olmo2/configuration_olmo2.py#L11)

( vocab\_size = 50304 hidden\_size = 4096 intermediate\_size = 11008 num\_hidden\_layers = 32 num\_attention\_heads = 32 num\_key\_value\_heads = None hidden\_act = 'silu' max\_position\_embeddings = 2048 initializer\_range = 0.02 use\_cache = True pad\_token\_id = 1 bos\_token\_id = None eos\_token\_id = 50279 tie\_word\_embeddings = False rope\_theta = 10000.0 rope\_scaling = None attention\_bias = False attention\_dropout = 0.0 rms\_norm\_eps = 1e-05 \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 50304) —
  ...
  `inputs_ids` passed when calling [Olmo2Model](/docs/transformers/v4.56.2/en/model_doc/olmo2#transformers.Olmo2Model)
...
This is the configuration class to store the configuration of a [Olmo2Model](/docs/transformers/v4.56.2/en/model_doc/olmo2#transformers.Olmo2Model). It is used to instantiate an OLMo2
...
### class transformers.Olmo2Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/olmo2/modeling_olmo2.py#L316)

( config: Olmo2Config  )

Parameters

* **config** ([Olmo2Config](/docs/transformers/v4.56.2/en/model_doc/olmo2#transformers.Olmo2Config)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/olmo2/modeling_olmo2.py#L333)
...
elements depending on the configuration ([Olmo2Config](/docs/transformers/v4.56.2/en/model_doc/olmo2#transformers.Olmo2Config)) and inputs.
...
The [Olmo2Model](/docs/transformers/v4.56.2/en/model_doc/olmo2#transformers.Olmo2Model) forward method, overrides the `__call__` special method.
...
### class transformers.Olmo2ForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/olmo2/modeling_olmo2.py#L395)

( config  )

Parameters

* **config** ([Olmo2ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/olmo2#transformers.Olmo2ForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/olmo2/modeling_olmo2.py#L409)
...
The [Olmo2ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/olmo2#transformers.Olmo2ForCausalLM) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/olmo2.md)
