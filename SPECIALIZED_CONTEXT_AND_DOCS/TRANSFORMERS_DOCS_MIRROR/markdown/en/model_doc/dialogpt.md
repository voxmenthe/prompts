...
modeling. We first concatenate all dialog turns within a dialogue session into a long text x\_1,…, x\_N (N is the
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/dialogpt.md)
