...
* All ASR models accept a float array corresponding to the raw waveform of the speech signal. The raw waveform should be pre-processed with [Wav2Vec2FeatureExtractor](/docs/transformers/v4.56.2/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor).
...
* You can load different language adapter weights for different languages via [load\_adapter()](/docs/transformers/v4.56.2/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC.load_adapter). Language adapters only consists of roughly 2 million parameters
...
just like we usually do for [Wav2Vec2ForCTC](/docs/transformers/v4.56.2/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC).
...
calling the convenient [load\_adapter()](/docs/transformers/v4.56.2/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC.load_adapter) function for the model and [set\_target\_lang()](/docs/transformers/v4.56.2/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.set_target_lang) for the tokenizer.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/mms.md)
