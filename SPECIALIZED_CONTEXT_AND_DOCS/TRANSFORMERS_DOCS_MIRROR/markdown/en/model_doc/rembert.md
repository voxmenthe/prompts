...
### class transformers.RemBertConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/configuration_rembert.py#L28)

( vocab\_size = 250300 hidden\_size = 1152 num\_hidden\_layers = 32 num\_attention\_heads = 18 input\_embedding\_size = 256 output\_embedding\_size = 1664 intermediate\_size = 4608 hidden\_act = 'gelu' hidden\_dropout\_prob = 0.0 attention\_probs\_dropout\_prob = 0.0 classifier\_dropout\_prob = 0.1 max\_position\_embeddings = 512 type\_vocab\_size = 2 initializer\_range = 0.02 layer\_norm\_eps = 1e-12 use\_cache = True pad\_token\_id = 0 bos\_token\_id = 312 eos\_token\_id = 313 \*\*kwargs  )

Parameters

* **vocab\_size** (`int`, *optional*, defaults to 250300) —
  Vocabulary size of the RemBERT model. Defines the number of different tokens that can be represented by the
  `inputs_ids` passed when calling [RemBertModel](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertModel) or `TFRemBertModel`. Vocabulary size of the model.
  Defines the different tokens that can be represented by the *inputs\_ids* passed to the forward method of
  [RemBertModel](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertModel).
* **hidden\_size** (`int`, *optional*, defaults to 1152) —
  Dimensionality of the encoder layers and the pooler layer.
* **num\_hidden\_layers** (`int`, *optional*, defaults to 32) —
  Number of hidden layers in the Transformer encoder.
* **num\_attention\_heads** (`int`, *optional*, defaults to 18) —
  Number of attention heads for each attention layer in the Transformer encoder.
* **input\_embedding\_size** (`int`, *optional*, defaults to 256) —
  Dimensionality of the input embeddings.
* **output\_embedding\_size** (`int`, *optional*, defaults to 1664) —
  Dimensionality of the output embeddings.
* **intermediate\_size** (`int`, *optional*, defaults to 4608) —
...
* **type\_vocab\_size** (`int`, *optional*, defaults to 2) —
  The vocabulary size of the `token_type_ids` passed when calling [RemBertModel](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertModel) or `TFRemBertModel`.
...
This is the configuration class to store the configuration of a [RemBertModel](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertModel). It is used to instantiate an
...
### class transformers.RemBertTokenizer
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/tokenization_rembert.py#L34)

( vocab\_file do\_lower\_case = False remove\_space = True keep\_accents = True bos\_token = '[CLS]' eos\_token = '[SEP]' unk\_token = '[UNK]' sep\_token = '[SEP]' pad\_token = '[PAD]' cls\_token = '[CLS]' mask\_token = '[MASK]' \*\*kwargs  )
...
#### build\_inputs\_with\_special\_tokens
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/tokenization_rembert.py#L163)
...
#### get\_special\_tokens\_mask
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/tokenization_rembert.py#L188)
...
#### save\_vocabulary
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/tokenization_rembert.py#L219)
...
### class transformers.RemBertTokenizerFast
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/tokenization_rembert_fast.py#L38)
...
#### build\_inputs\_with\_special\_tokens
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/tokenization_rembert_fast.py#L128)
...
* **token\_ids\_0** (`List[int]`) —
  List of IDs to which the special tokens will be added
* **token\_ids\_1** (`List[int]`, *optional*, defaults to `None`) —
  Optional second list of IDs for sequence pairs.
...
#### get\_special\_tokens\_mask
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/tokenization_rembert_fast.py#L153)
...
#### save\_vocabulary
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/tokenization_rembert_fast.py#L184)
...
### class transformers.RemBertModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L650)

( config add\_pooling\_layer = True  )

Parameters

* **config** ([RemBertModel](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertModel)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L681)
...
elements depending on the configuration ([RemBertConfig](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertConfig)) and inputs.
...
The [RemBertModel](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertModel) forward method, overrides the `__call__` special method.
...
### class transformers.RemBertForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L904)

( config  )

Parameters

* **config** ([RemBertForCausalLM](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L925)

( input\_ids: typing.Optional[torch.LongTensor] = None attention\_mask: typing.Optional[torch.LongTensor] = None token\_type\_ids: typing.Optional[torch.LongTensor] = None position\_ids: typing.Optional[torch.LongTensor] = None head\_mask: typing.Optional[torch.FloatTensor] = None inputs\_embeds: typing.Optional[torch.FloatTensor] = None encoder\_hidden\_states: typing.Optional[torch.FloatTensor] = None encoder\_attention\_mask: typing.Optional[torch.FloatTensor] = None past\_key\_values: typing.Optional[tuple[tuple[torch.FloatTensor]]] = None labels: typing.Optional[torch.LongTensor] = None use\_cache: typing.Optional[bool] = None output\_attentions: typing.Optional[bool] = None output\_hidden\_states: typing.Optional[bool] = None return\_dict: typing.Optional[bool] = None \*\*kwargs  ) → [transformers.modeling\_outputs.CausalLMOutputWithCrossAttentions](/docs/transformers/v4.56.2/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions) or `tuple(torch.FloatTensor)`
...
The [RemBertForCausalLM](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.RemBertForMaskedLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L795)

( config  )

Parameters

* **config** ([RemBertForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForMaskedLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L819)
...
The [RemBertForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForMaskedLM) forward method, overrides the `__call__` special method.
...
### class transformers.RemBertForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L1016)

( config  )

Parameters

* **config** ([RemBertForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForSequenceClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L1027)

( input\_ids: typing.Optional[torch.FloatTensor] = None attention\_mask: typing.Optional[torch.FloatTensor] = None token\_type\_ids: typing.Optional[torch.LongTensor] = None position\_ids: typing.Optional[torch.FloatTensor] = None head\_mask: typing.Optional[torch.FloatTensor] = None inputs\_embeds: typing.Optional[torch.FloatTensor] = None labels: typing.Optional[torch.LongTensor] = None output\_attentions: typing.Optional[bool] = None output\_hidden\_states: typing.Optional[bool] = None return\_dict: typing.Optional[bool] = None  ) → [transformers.modeling\_outputs.SequenceClassifierOutput](/docs/transformers/v4.56.2/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput) or `tuple(torch.FloatTensor)`
...
The [RemBertForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.RemBertForMultipleChoice
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L1101)

( config  )

Parameters

* **config** ([RemBertForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForMultipleChoice)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L1112)
...
The [RemBertForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
### class transformers.RemBertForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L1205)

( config  )

Parameters

* **config** ([RemBertForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForTokenClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L1217)
...
The [RemBertForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForTokenClassification) forward method, overrides the `__call__` special method.
...
### class transformers.RemBertForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L1272)

( config  )

Parameters

* **config** ([RemBertForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForQuestionAnswering)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/rembert/modeling_rembert.py#L1284)

( input\_ids: typing.Optional[torch.FloatTensor] = None attention\_mask: typing.Optional[torch.FloatTensor] = None token\_type\_ids: typing.Optional[torch.LongTensor] = None position\_ids: typing.Optional[torch.FloatTensor] = None head\_mask: typing.Optional[torch.FloatTensor] = None inputs\_embeds: typing.Optional[torch.FloatTensor] = None start\_positions: typing.Optional[torch.LongTensor] = None end\_positions: typing.Optional[torch.LongTensor] = None output\_attentions: typing.Optional[bool] = None output\_hidden\_states: typing.Optional[bool] = None return\_dict: typing.Optional[bool] = None  ) → [transformers.modeling\_outputs.QuestionAnsweringModelOutput](/docs/transformers/v4.56.2/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput) or `tuple(torch.FloatTensor)`
...
The [RemBertForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/rembert#transformers.RemBertForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/rembert.md)
