...
### class transformers.DeepseekVLHybridConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/configuration_deepseek_vl_hybrid.py#L29)

( text\_config: AutoConfig = None vision\_config: AutoConfig = None high\_res\_vision\_config: AutoConfig = None image\_token\_id: int = 100015 \*\*kwargs  )
...
* **high\_res\_vision\_config** (`Union[AutoConfig, dict]`, *optional*, defaults to `SamVisionConfig`) —
...
This is the configuration class to store the configuration of a [DeepseekVLHybridModel](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridModel). It is used to instantiate a
...
### class transformers.DeepseekVLHybridProcessor
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/processing_deepseek_vl_hybrid.py#L36)

( image\_processor tokenizer chat\_template = None num\_image\_tokens = 576  )

Parameters

* **image\_processor** ([DeepseekVLHybridImageProcessor](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridImageProcessor)) —
...
`__call__()` and [decode()](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridProcessor.decode) for more information.

#### batch\_decode

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/processing_deepseek_vl_hybrid.py#L137)
...
#### decode
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/processing_deepseek_vl_hybrid.py#L144)
...
### class transformers.DeepseekVLHybridImageProcessor
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/image_processing_deepseek_vl_hybrid.py#L57)

( do\_resize: bool = True size: typing.Optional[dict[str, int]] = None high\_res\_size: typing.Optional[dict[str, int]] = None min\_size: int = 14 resample: Resampling = <Resampling.BICUBIC: 3> high\_res\_resample: Resampling = <Resampling.BICUBIC: 3> do\_rescale: bool = True rescale\_factor: typing.Union[int, float] = 0.00392156862745098 do\_normalize: bool = True image\_mean: typing.Union[float, list[float], NoneType] = None image\_std: typing.Union[float, list[float], NoneType] = None high\_res\_image\_mean: typing.Union[float, list[float], NoneType] = None high\_res\_image\_std: typing.Union[float, list[float], NoneType] = None do\_convert\_rgb: typing.Optional[bool] = None \*\*kwargs  )
...
* **size** (`dict`, *optional*, defaults to `{"height" -- 384, "width": 384}`):
  ...
  method.
* **high\_res\_size** (`dict`, *optional*, defaults to `{"height" -- 1024, "width": 1024}`):
...
* **high\_res\_resample** (`PILImageResampling`, *optional*, defaults to `Resampling.BICUBIC`) —
  Resampling filter to use if resizing the image. Only has an effect if `do_resize` is set to `True`. Can be
...
* **high\_res\_image\_mean** (`float` or `list[float]`, *optional*, defaults to `OPENAI_CLIP_MEAN`) —
...
* **high\_res\_image\_std** (`float` or `list[float]`, *optional*, defaults to `OPENAI_CLIP_STD`) —
...
Constructs a DEEPSEEK\_VL\_HYBRID image processor.

#### pad\_to\_square

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/image_processing_deepseek_vl_hybrid.py#L415)
...
#### preprocess
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/image_processing_deepseek_vl_hybrid.py#L236)

( images: typing.Union[ForwardRef('PIL.Image.Image'), numpy.ndarray, ForwardRef('torch.Tensor'), list['PIL.Image.Image'], list[numpy.ndarray], list['torch.Tensor']] do\_resize: typing.Optional[bool] = None size: typing.Optional[dict[str, int]] = None high\_res\_size: typing.Optional[dict[str, int]] = None resample: Resampling = None high\_res\_resample: Resampling = None do\_rescale: typing.Optional[bool] = None rescale\_factor: typing.Optional[float] = None do\_normalize: typing.Optional[bool] = None image\_mean: typing.Union[float, list[float], NoneType] = None image\_std: typing.Union[float, list[float], NoneType] = None high\_res\_image\_mean: typing.Union[float, list[float], NoneType] = None high\_res\_image\_std: typing.Union[float, list[float], NoneType] = None return\_tensors: typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None data\_format: typing.Union[str, transformers.image\_utils.ChannelDimension] = <ChannelDimension.FIRST: 'channels\_first'> input\_data\_format: typing.Union[str, transformers.image\_utils.ChannelDimension, NoneType] = None do\_convert\_rgb: typing.Optional[bool] = None  )
...
* **size** (`Dict[str, int]`, *optional*, defaults to `self.size`) —
  ...
  resizing.
* **high\_res\_size** (`Dict[str, int]`, *optional*, defaults to `self.high_res_size`) —
...
* **high\_res\_resample** (`PILImageResampling` filter, *optional*, defaults to `self.resample`) —
...
* **high\_res\_image\_mean** (`float` or `List[float]`, *optional*, defaults to `self.high_res_image_mean`) —
  Image mean to use if `do_normalize` is set to `True`.
* **high\_res\_image\_std** (`float` or `List[float]`, *optional*, defaults to `self.high_res_image_std`) —
  Image standard deviation to use if `do_normalize` is set to `True`.
...
#### resize
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/image_processing_deepseek_vl_hybrid.py#L161)
...
### class transformers.DeepseekVLHybridImageProcessorFast
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/image_processing_deepseek_vl_hybrid_fast.py#L80)

( \*\*kwargs: typing\_extensions.Unpack[transformers.models.deepseek\_vl\_hybrid.image\_processing\_deepseek\_vl\_hybrid\_fast.DeepseekVLHybridFastImageProcessorKwargs]  )

Constructs a fast Deepseek Vl Hybrid image processor.

#### pad\_to\_square

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/image_processing_deepseek_vl_hybrid_fast.py#L136)
...
### class transformers.DeepseekVLHybridModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/modeling_deepseek_vl_hybrid.py#L249)

( config  )

Parameters

* **config** ([DeepseekVLHybridModel](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridModel)) —
...
* **pixel\_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`) —
  ...
  [DeepseekVLHybridImageProcessor](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridImageProcessor). See [DeepseekVLHybridImageProcessor.**call**()](/docs/transformers/v4.56.2/en/model_doc/fuyu#transformers.FuyuImageProcessor.__call__) for details ([DeepseekVLHybridProcessor](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridProcessor) uses
  [DeepseekVLHybridImageProcessor](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridImageProcessor) for processing images).
* **high\_res\_pixel\_values** (`torch.FloatTensor` of shape `(batch\_size, num\_channels, image\_size, image\_size), *optional*) —
  The tensors corresponding to the input images. Pixel values can be obtained using
  [AutoImageProcessor](/docs/transformers/v4.56.2/en/model_doc/auto#transformers.AutoImageProcessor).
...
The [DeepseekVLHybridModel](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridModel) forward method, overrides the `__call__` special method.
...
### class transformers.DeepseekVLHybridForConditionalGeneration
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/modeling_deepseek_vl_hybrid.py#L397)

( config: DeepseekVLHybridConfig  )

#### forward

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deepseek_vl_hybrid/modeling_deepseek_vl_hybrid.py#L419)
...
The [DeepseekVLHybridForConditionalGeneration](/docs/transformers/v4.56.2/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/deepseek_vl_hybrid.md)
