...
### class transformers.Phi3Config
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi3/configuration_phi3.py#L25)

( vocab\_size = 32064 hidden\_size = 3072 intermediate\_size = 8192 num\_hidden\_layers = 32 num\_attention\_heads = 32 num\_key\_value\_heads = None resid\_pdrop = 0.0 embd\_pdrop = 0.0 attention\_dropout = 0.0 hidden\_act = 'silu' max\_position\_embeddings = 4096 original\_max\_position\_embeddings = 4096 initializer\_range = 0.02 rms\_norm\_eps = 1e-05 use\_cache = True tie\_word\_embeddings = False rope\_theta = 10000.0 rope\_scaling = None partial\_rotary\_factor = 1.0 bos\_token\_id = 1 eos\_token\_id = 32000 pad\_token\_id = 32000 sliding\_window = None \*\*kwargs  )
...
* **eos\_token\_id** (`int`, *optional*, defaults to 32000) —
  The id of the “end-of-sequence” token.
* **pad\_token\_id** (`int`, *optional*, defaults to 32000) —
  The id of the padding token.
* **sliding\_window** (`int`, *optional*) —
  Sliding window attention window size. If `None`, no sliding window is applied.

This is the configuration class to store the configuration of a [Phi3Model](/docs/transformers/v4.56.2/en/model_doc/phi3#transformers.Phi3Model). It is used to instantiate a Phi-3
...
### class transformers.Phi3Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi3/modeling_phi3.py#L339)

( config: Phi3Config  )

Parameters

* **config** ([Phi3Config](/docs/transformers/v4.56.2/en/model_doc/phi3#transformers.Phi3Config)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi3/modeling_phi3.py#L356)
...
elements depending on the configuration ([Phi3Config](/docs/transformers/v4.56.2/en/model_doc/phi3#transformers.Phi3Config)) and inputs.
...
The [Phi3Model](/docs/transformers/v4.56.2/en/model_doc/phi3#transformers.Phi3Model) forward method, overrides the `__call__` special method.
...
### class transformers.Phi3ForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi3/modeling_phi3.py#L419)

( config  )

Parameters

* **config** ([Phi3ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/phi3#transformers.Phi3ForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi3/modeling_phi3.py#L433)
...
The [Phi3ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/phi3#transformers.Phi3ForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.Phi3ForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi3/modeling_phi3.py#L533)
...
### class transformers.Phi3ForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi3/modeling_phi3.py#L537)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/phi3.md)
