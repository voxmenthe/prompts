...
### class transformers.FNetConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/configuration_fnet.py#L24)

( vocab\_size = 32000 hidden\_size = 768 num\_hidden\_layers = 12 intermediate\_size = 3072 hidden\_act = 'gelu\_new' hidden\_dropout\_prob = 0.1 max\_position\_embeddings = 512 type\_vocab\_size = 4 initializer\_range = 0.02 layer\_norm\_eps = 1e-12 use\_tpu\_fourier\_optimizations = False tpu\_short\_seq\_length = 512 pad\_token\_id = 3 bos\_token\_id = 1 eos\_token\_id = 2 \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 32000) —
  ...
  `inputs_ids` passed when calling [FNetModel](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetModel) or `TFFNetModel`.
...
* **type\_vocab\_size** (`int`, *optional*, defaults to 4) —
  The vocabulary size of the `token_type_ids` passed when calling [FNetModel](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetModel) or `TFFNetModel`.
* **initializer\_range** (`float`, *optional*, defaults to 0.02) —
  The standard deviation of the truncated\_normal\_initializer for initializing all weight matrices.
* **layer\_norm\_eps** (`float`, *optional*, defaults to 1e-12) —
  The epsilon used by the layer normalization layers.
* **use\_tpu\_fourier\_optimizations** (`bool`, *optional*, defaults to `False`) —
...
* **tpu\_short\_seq\_length** (`int`, *optional*, defaults to 512) —
  The sequence length that is expected by the model when using TPUs. This will be used to initialize the DFT
  matrix only when *use\_tpu\_fourier\_optimizations* is set to `True` and the input sequence is shorter than or
  equal to 4096 tokens.

This is the configuration class to store the configuration of a [FNetModel](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetModel). It is used to instantiate an FNet
...
### class transformers.FNetTokenizer
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/tokenization_fnet.py#L37)

( vocab\_file do\_lower\_case = False remove\_space = True keep\_accents = True unk\_token = '<unk>' sep\_token = '[SEP]' pad\_token = '<pad>' cls\_token = '[CLS]' mask\_token = '[MASK]' sp\_model\_kwargs: typing.Optional[dict[str, typing.Any]] = None \*\*kwargs  )
...
* **keep\_accents** (`bool`, *optional*, defaults to `True`) —
...
[SentencePiece](https://github.com/google/sentencepiece). This tokenizer inherits from [PreTrainedTokenizer](/docs/transformers/v4.56.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizer)
...
#### build\_inputs\_with\_special\_tokens
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/tokenization_fnet.py#L243)
...
#### get\_special\_tokens\_mask
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/tokenization_fnet.py#L268)
...
#### save\_vocabulary
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/tokenization_fnet.py#L296)
...
### class transformers.FNetTokenizerFast
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/tokenization_fnet_fast.py#L38)

( vocab\_file = None tokenizer\_file = None do\_lower\_case = False remove\_space = True keep\_accents = True unk\_token = '<unk>' sep\_token = '[SEP]' pad\_token = '<pad>' cls\_token = '[CLS]' mask\_token = '[MASK]' \*\*kwargs  )
...
[AlbertTokenizerFast](/docs/transformers/v4.56.2/en/model_doc/albert#transformers.AlbertTokenizerFast). Based on
...
#### build\_inputs\_with\_special\_tokens
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/tokenization_fnet_fast.py#L116)
...
### class transformers.FNetModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L436)

( config add\_pooling\_layer = True  )

Parameters

* **config** ([FNetModel](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetModel)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L466)

( input\_ids: typing.Optional[torch.LongTensor] = None token\_type\_ids: typing.Optional[torch.LongTensor] = None position\_ids: typing.Optional[torch.LongTensor] = None inputs\_embeds: typing.Optional[torch.FloatTensor] = None output\_hidden\_states: typing.Optional[bool] = None return\_dict: typing.Optional[bool] = None  ) → [transformers.modeling\_outputs.BaseModelOutput](/docs/transformers/v4.56.2/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput) or `tuple(torch.FloatTensor)`
...
elements depending on the configuration ([FNetConfig](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetConfig)) and inputs.
...
The [FNetModel](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetModel) forward method, overrides the `__call__` special method.
...
### class transformers.FNetForPreTraining
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L543)

( config  )

Parameters

* **config** ([FNetForPreTraining](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForPreTraining)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L562)
...
The [FNetForPreTraining](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForPreTraining) forward method, overrides the `__call__` special method.
...
### class transformers.FNetForMaskedLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L633)

( config  )

Parameters

* **config** ([FNetForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForMaskedLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L652)
...
The [FNetForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForMaskedLM) forward method, overrides the `__call__` special method.
...
### class transformers.FNetForNextSentencePrediction
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L700)

( config  )

Parameters

* **config** ([FNetForNextSentencePrediction](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForNextSentencePrediction)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L710)
...
The [FNetForNextSentencePrediction](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
### class transformers.FNetForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L791)

( config  )

Parameters

* **config** ([FNetForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForSequenceClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L803)
...
The [FNetForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.FNetForMultipleChoice
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L865)

( config  )

Parameters

* **config** ([FNetForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForMultipleChoice)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L876)
...
The [FNetForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForMultipleChoice) forward method, overrides the `__call__` special method.
...
### class transformers.FNetForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L957)

( config  )

Parameters

* **config** ([FNetForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForTokenClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L970)
...
The [FNetForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForTokenClassification) forward method, overrides the `__call__` special method.
...
### class transformers.FNetForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L1015)

( config  )

Parameters

* **config** ([FNetForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForQuestionAnswering)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/fnet/modeling_fnet.py#L1027)
...
The [FNetForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/fnet#transformers.FNetForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/fnet.md)
