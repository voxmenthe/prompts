...
* **resolution** (`int`, *optional*, defaults to 7) —
  Size of each patch
* **num\_hidden\_layers** (`int`, *optional*, defaults to 5) —
...
* **mlp\_expansion\_ratio** (`int`, *optional*, defaults to 4) —
...
* **downsample\_patch\_size** (`int`, *optional*, defaults to 3) —
  The size of patches in downsampling layers.
* **downsample\_stride** (`int`, *optional*, defaults to 2) —
  The stride of convolution kernels in downsampling layers.
* **downsample\_pad** (`int`, *optional*, defaults to 1) —
  Padding in downsampling layers.
* **drop\_path\_rate** (`int`, *optional*, defaults to 0) —
  Rate at which to increase dropout probability in DropPath.
* **num\_meta3d\_blocks** (`int`, *optional*, defaults to 1) —
...
* **layer\_scale\_init\_value** (`float`, *optional*, defaults to 1e-5) —
...
This is the configuration class to store the configuration of an [EfficientFormerModel](/docs/transformers/v4.56.2/en/model_doc/efficientformer#transformers.EfficientFormerModel). It is used to
...
### class transformers.EfficientFormerImageProcessor
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/efficientformer/image_processing_efficientformer.py#L47)

( do\_resize: bool = True size: typing.Optional[dict[str, int]] = None resample: Resampling = <Resampling.BICUBIC: 3> do\_center\_crop: bool = True do\_rescale: bool = True rescale\_factor: typing.Union[int, float] = 0.00392156862745098 crop\_size: typing.Optional[dict[str, int]] = None do\_normalize: bool = True image\_mean: typing.Union[float, list[float], NoneType] = None image\_std: typing.Union[float, list[float], NoneType] = None \*\*kwargs  )
...
#### preprocess
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/efficientformer/image_processing_efficientformer.py#L178)
...
### class transformers.EfficientFormerModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/efficientformer/modeling_efficientformer.py#L549)

( config: EfficientFormerConfig  )

Parameters

* **config** ([EfficientFormerConfig](/docs/transformers/v4.56.2/en/model_doc/efficientformer#transformers.EfficientFormerConfig)) — Model configuration class with all the parameters of the model.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/efficientformer/modeling_efficientformer.py#L562)
...
* **pixel\_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) —
  Pixel values. Pixel values can be obtained using [ViTImageProcessor](/docs/transformers/v4.56.2/en/model_doc/vit#transformers.ViTImageProcessor). See
  [ViTImageProcessor.preprocess()](/docs/transformers/v4.56.2/en/model_doc/vit#transformers.ViTImageProcessor.preprocess) for details.
...
elements depending on the configuration ([EfficientFormerConfig](/docs/transformers/v4.56.2/en/model_doc/efficientformer#transformers.EfficientFormerConfig)) and inputs.
...
The [EfficientFormerModel](/docs/transformers/v4.56.2/en/model_doc/efficientformer#transformers.EfficientFormerModel) forward method, overrides the `__call__` special method.
...
### class transformers.EfficientFormerForImageClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/efficientformer/modeling_efficientformer.py#L612)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/efficientformer/modeling_efficientformer.py#L627)
...
The [EfficientFormerForImageClassification](/docs/transformers/v4.56.2/en/model_doc/efficientformer#transformers.EfficientFormerForImageClassification) forward method, overrides the `__call__` special method.
...
### class transformers.EfficientFormerForImageClassificationWithTeacher
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/efficientformer/modeling_efficientformer.py#L742)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/efficientformer/modeling_efficientformer.py#L759)

( pixel\_values: typing.Optional[torch.Tensor] = None output\_attentions: typing.Optional[bool] = None output\_hidden\_states: typing.Optional[bool] = None return\_dict: typing.Optional[bool] = None  ) → `transformers.models.deprecated.efficientformer.modeling_efficientformer.EfficientFormerForImageClassificationWithTeacherOutput` or `tuple(torch.FloatTensor)`
...
The [EfficientFormerForImageClassificationWithTeacher](/docs/transformers/v4.56.2/en/model_doc/efficientformer#transformers.EfficientFormerForImageClassificationWithTeacher) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/efficientformer.md)
