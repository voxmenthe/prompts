...
The examples below demonstrate how to classify an image with [Pipeline](/docs/transformers/v4.56.2/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v4.56.2/en/model_doc/auto#transformers.AutoModel) class.
...
* While trained on images of a specific sizes, the model architecture works with images of different sizes (minimum 32x32). The [MobileNetV2ImageProcessor](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2ImageProcessor) handles the necessary preprocessing.
...
* The original TensorFlow checkpoints determines the padding amount at inference because it depends on the input image size. To use the native PyTorch padding behavior, set `tf_padding=False` in [MobileNetV2Config](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2Config).
...
### class transformers.MobileNetV2Config
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/configuration_mobilenet_v2.py#L30)

( num\_channels = 3 image\_size = 224 depth\_multiplier = 1.0 depth\_divisible\_by = 8 min\_depth = 8 expand\_ratio = 6.0 output\_stride = 32 first\_layer\_is\_expansion = True finegrained\_output = True hidden\_act = 'relu6' tf\_padding = True classifier\_dropout\_prob = 0.8 initializer\_range = 0.02 layer\_norm\_eps = 0.001 semantic\_loss\_ignore\_index = 255 \*\*kwargs  )
...
* **depth\_divisible\_by** (`int`, *optional*, defaults to 8) —
...
* **expand\_ratio** (`float`, *optional*, defaults to 6.0) —
...
* **first\_layer\_is\_expansion** (`bool`, *optional*, defaults to `True`) —
  True if the very first convolution layer is also the expansion layer for the first expansion block.
* **finegrained\_output** (`bool`, *optional*, defaults to `True`) —
...
* **classifier\_dropout\_prob** (`float`, *optional*, defaults to 0.8) —
...
This is the configuration class to store the configuration of a [MobileNetV2Model](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2Model). It is used to instantiate a
...
[google/mobilenet\_v2\_1.0\_224](https://huggingface.co/google/mobilenet_v2_1.0_224) architecture.
...
### class transformers.MobileNetV2FeatureExtractor
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/feature_extraction_mobilenet_v2.py#L28)

( \*args \*\*kwargs  )

#### preprocess

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2.py#L322)
...
#### post\_process\_semantic\_segmentation
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2.py#L479)
...
### class transformers.MobileNetV2ImageProcessor
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2.py#L54)
...
### class transformers.MobileNetV2ImageProcessorFast
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2_fast.py#L67)

( \*\*kwargs: typing\_extensions.Unpack[transformers.models.mobilenet\_v2.image\_processing\_mobilenet\_v2\_fast.MobileNetV2FastImageProcessorKwargs]  )

Constructs a fast Mobilenet V2 image processor.

#### preprocess

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2_fast.py#L95)

( images: typing.Union[ForwardRef('PIL.Image.Image'), numpy.ndarray, ForwardRef('torch.Tensor'), list['PIL.Image.Image'], list[numpy.ndarray], list['torch.Tensor']] segmentation\_maps: typing.Union[ForwardRef('PIL.Image.Image'), numpy.ndarray, ForwardRef('torch.Tensor'), list['PIL.Image.Image'], list[numpy.ndarray], list['torch.Tensor'], NoneType] = None \*\*kwargs: typing\_extensions.Unpack[transformers.models.mobilenet\_v2.image\_processing\_mobilenet\_v2\_fast.MobileNetV2FastImageProcessorKwargs]  ) → `<class 'transformers.image_processing_base.BatchFeature'>`
...
#### post\_process\_semantic\_segmentation
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2_fast.py#L211)
...
### class transformers.MobileNetV2Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L444)

( config: MobileNetV2Config add\_pooling\_layer: bool = True  )

Parameters

* **config** ([MobileNetV2Config](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2Config)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L512)
...
* **pixel\_values** (`torch.Tensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) —
  ...
  [MobileNetV2ImageProcessor](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2ImageProcessor). See `MobileNetV2ImageProcessor.__call__()` for details (`processor_class` uses
  [MobileNetV2ImageProcessor](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2ImageProcessor) for processing images).
...
elements depending on the configuration ([MobileNetV2Config](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2Config)) and inputs.
...
The [MobileNetV2Model](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2Model) forward method, overrides the `__call__` special method.
...
### class transformers.MobileNetV2ForImageClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L560)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L576)
...
The [MobileNetV2ForImageClassification](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2ForImageClassification) forward method, overrides the `__call__` special method.
...
### class transformers.MobileNetV2ForSemanticSegmentation
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L712)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L723)
...
The [MobileNetV2ForSemanticSegmentation](/docs/transformers/v4.56.2/en/model_doc/mobilenet_v2#transformers.MobileNetV2ForSemanticSegmentation) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/mobilenet_v2.md)
