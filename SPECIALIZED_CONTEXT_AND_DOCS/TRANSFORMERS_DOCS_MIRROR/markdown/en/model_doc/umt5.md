...
* **vocab\_size** (`int`, *optional*, defaults to 250112) —
  ...
  `inputs_ids` passed when calling [UMT5Model](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5Model) or `TFUMT5Model`.
...
This is the configuration class to store the configuration of a [UMT5Model](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5Model). It is used to instantiate a UMT5
...
### class transformers.UMT5Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L939)

( config  )

Parameters

* **config** ([UMT5Model](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5Model)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1009)
...
elements depending on the configuration ([UMT5Config](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5Config)) and inputs.
...
The [UMT5Model](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5Model) forward method, overrides the `__call__` special method.
...
### class transformers.UMT5ForConditionalGeneration
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1150)

( config  )

Parameters

* **config** ([UMT5ForConditionalGeneration](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5ForConditionalGeneration)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1213)
...
The [UMT5ForConditionalGeneration](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### class transformers.UMT5EncoderModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1381)

( config  )

Parameters

* **config** ([UMT5EncoderModel](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5EncoderModel)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1439)
...
The [UMT5EncoderModel](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5EncoderModel) forward method, overrides the `__call__` special method.
...
### class transformers.UMT5ForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1495)

( config: UMT5Config  )

Parameters

* **config** ([UMT5Config](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5Config)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1510)
...
The [UMT5ForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5ForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.UMT5ForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1659)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1675)
...
The [UMT5ForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5ForTokenClassification) forward method, overrides the `__call__` special method.
...
### class transformers.UMT5ForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1736)

( config  )

Parameters

* **config** ([UMT5ForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5ForQuestionAnswering)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/umt5/modeling_umt5.py#L1783)
...
The [UMT5ForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/umt5#transformers.UMT5ForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/umt5.md)
