...
### class transformers.GraniteMoeConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoe/configuration_granitemoe.py#L30)

( vocab\_size = 32000 hidden\_size = 4096 intermediate\_size = 11008 num\_hidden\_layers = 32 num\_attention\_heads = 32 num\_key\_value\_heads = None hidden\_act = 'silu' max\_position\_embeddings = 2048 initializer\_range = 0.02 rms\_norm\_eps = 1e-06 use\_cache = True pad\_token\_id = None bos\_token\_id = 1 eos\_token\_id = 2 tie\_word\_embeddings = False rope\_theta = 10000.0 rope\_scaling = None attention\_bias = False attention\_dropout = 0.0 embedding\_multiplier = 1.0 logits\_scaling = 1.0 residual\_multiplier = 1.0 attention\_multiplier = 1.0 num\_local\_experts = 8 num\_experts\_per\_tok = 2 output\_router\_logits = False router\_aux\_loss\_coef = 0.001 \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 32000) —
  ...
  `inputs_ids` passed when calling [GraniteMoeModel](/docs/transformers/v4.56.2/en/model_doc/granitemoe#transformers.GraniteMoeModel)
...
This is the configuration class to store the configuration of a [GraniteMoeModel](/docs/transformers/v4.56.2/en/model_doc/granitemoe#transformers.GraniteMoeModel). It is used to instantiate an GraniteMoe
...
### class transformers.GraniteMoeModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoe/modeling_granitemoe.py#L613)

( config: GraniteMoeConfig  )

Parameters

* **config** ([GraniteMoeConfig](/docs/transformers/v4.56.2/en/model_doc/granitemoe#transformers.GraniteMoeConfig)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoe/modeling_granitemoe.py#L639)
...
elements depending on the configuration ([GraniteMoeConfig](/docs/transformers/v4.56.2/en/model_doc/granitemoe#transformers.GraniteMoeConfig)) and inputs.
...
The [GraniteMoeModel](/docs/transformers/v4.56.2/en/model_doc/granitemoe#transformers.GraniteMoeModel) forward method, overrides the `__call__` special method.
...
### class transformers.GraniteMoeForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoe/modeling_granitemoe.py#L876)

( config: GraniteMoeConfig  )

#### forward

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoe/modeling_granitemoe.py#L892)
...
The [GraniteMoeForCausalLM](/docs/transformers/v4.56.2/en/model_doc/granitemoe#transformers.GraniteMoeForCausalLM) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/granitemoe.md)
