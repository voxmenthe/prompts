...
### class transformers.Cohere2Config
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/cohere2/configuration_cohere2.py#L28)

( vocab\_size = 256000 hidden\_size = 8192 intermediate\_size = 22528 logit\_scale = 0.0625 num\_hidden\_layers = 40 num\_attention\_heads = 64 num\_key\_value\_heads = None hidden\_act = 'silu' max\_position\_embeddings = 8192 initializer\_range = 0.02 layer\_norm\_eps = 1e-05 use\_cache = True pad\_token\_id = 0 bos\_token\_id = 5 eos\_token\_id = 255001 tie\_word\_embeddings = True rope\_theta = 10000.0 rope\_scaling = None attention\_bias = False attention\_dropout = 0.0 sliding\_window = 4096 layer\_types = None \*\*kwargs  )
...
### class transformers.Cohere2Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/cohere2/modeling_cohere2.py#L337)

( config: Cohere2Config  )

Parameters

* **config** ([Cohere2Config](/docs/transformers/v4.56.2/en/model_doc/cohere2#transformers.Cohere2Config)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/cohere2/modeling_cohere2.py#L354)
...
elements depending on the configuration ([Cohere2Config](/docs/transformers/v4.56.2/en/model_doc/cohere2#transformers.Cohere2Config)) and inputs.
...
The [Cohere2Model](/docs/transformers/v4.56.2/en/model_doc/cohere2#transformers.Cohere2Model) forward method, overrides the `__call__` special method.
...
### class transformers.Cohere2ForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/cohere2/modeling_cohere2.py#L420)

( config  )

Parameters

* **config** ([Cohere2ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/cohere2#transformers.Cohere2ForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/cohere2/modeling_cohere2.py#L436)
...
The [Cohere2ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/cohere2#transformers.Cohere2ForCausalLM) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/cohere2.md)
