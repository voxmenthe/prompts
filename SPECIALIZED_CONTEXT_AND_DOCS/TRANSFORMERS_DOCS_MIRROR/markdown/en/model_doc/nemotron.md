...
### class transformers.NemotronConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/nemotron/configuration_nemotron.py#L26)

( vocab\_size = 256000 hidden\_size = 6144 intermediate\_size = 24576 num\_hidden\_layers = 32 num\_attention\_heads = 48 head\_dim = None num\_key\_value\_heads = None hidden\_act = 'relu2' max\_position\_embeddings = 4096 initializer\_range = 0.0134 norm\_eps = 1e-05 use\_cache = True pad\_token\_id = None bos\_token\_id = 2 eos\_token\_id = 3 tie\_word\_embeddings = False rope\_theta = 10000.0 partial\_rotary\_factor = 0.5 attention\_bias = False attention\_dropout = 0.0 mlp\_bias = False \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 256000) —
  ...
  `inputs_ids` passed when calling [NemotronModel](/docs/transformers/v4.56.2/en/model_doc/nemotron#transformers.NemotronModel)
...
* **num\_attention\_heads** (`int`, *optional*, defaults to 48) —
  Number of attention heads for each attention layer in the Transformer decoder.
* **head\_dim** (`int`, *optional*) —
  Projection weights dimension in multi-head attention. Set to hidden\_size // num\_attention\_heads if None
...
* **initializer\_range** (`float`, *optional*, defaults to 0.0134) —
...
* **partial\_rotary\_factor** (`float`, *optional*, defaults to 0.5) — Percentage of the query and keys which will have rotary embedding.
...
* **mlp\_bias** (`bool`, *optional*, defaults to `False`) —
  Whether to use a bias in up\_proj and down\_proj layers in the MLP layers.

This is the configuration class to store the configuration of a [NemotronModel](/docs/transformers/v4.56.2/en/model_doc/nemotron#transformers.NemotronModel). It is used to instantiate an Nemotron
...
### class transformers.NemotronModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/nemotron/modeling_nemotron.py#L615)

( config: NemotronConfig  )

Parameters

* **config** ([NemotronConfig](/docs/transformers/v4.56.2/en/model_doc/nemotron#transformers.NemotronConfig)) —
...
elements depending on the configuration ([NemotronConfig](/docs/transformers/v4.56.2/en/model_doc/nemotron#transformers.NemotronConfig)) and inputs.
...
The [NemotronModel](/docs/transformers/v4.56.2/en/model_doc/nemotron#transformers.NemotronModel) forward method, overrides the `__call__` special method.
...
### class transformers.NemotronForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/nemotron/modeling_nemotron.py#L859)

( config  )

#### forward

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/nemotron/modeling_nemotron.py#L871)
...
The [NemotronForCausalLM](/docs/transformers/v4.56.2/en/model_doc/nemotron#transformers.NemotronForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.NemotronForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/nemotron/modeling_nemotron.py#L946)
...
### class transformers.NemotronForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/nemotron/modeling_nemotron.py#L949)
...
### class transformers.NemotronForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/nemotron/modeling_nemotron.py#L953)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/nemotron.md)
