...
### class transformers.Qwen3Config
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/qwen3/configuration_qwen3.py#L25)

( vocab\_size = 151936 hidden\_size = 4096 intermediate\_size = 22016 num\_hidden\_layers = 32 num\_attention\_heads = 32 num\_key\_value\_heads = 32 head\_dim = 128 hidden\_act = 'silu' max\_position\_embeddings = 32768 initializer\_range = 0.02 rms\_norm\_eps = 1e-06 use\_cache = True tie\_word\_embeddings = False rope\_theta = 10000.0 rope\_scaling = None attention\_bias = False use\_sliding\_window = False sliding\_window = 4096 max\_window\_layers = 28 layer\_types = None attention\_dropout = 0.0 \*\*kwargs  )

Parameters

* **vocab\_size** (`int`, *optional*, defaults to 151936) —
  Vocabulary size of the Qwen3 model. Defines the number of different tokens that can be represented by the
  `inputs_ids` passed when calling [Qwen3Model](/docs/transformers/v4.56.2/en/model_doc/qwen3#transformers.Qwen3Model)
...
This is the configuration class to store the configuration of a [Qwen3Model](/docs/transformers/v4.56.2/en/model_doc/qwen3#transformers.Qwen3Model). It is used to instantiate a
...
### class transformers.Qwen3Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/qwen3/modeling_qwen3.py#L336)

( config: Qwen3Config  )

Parameters

* **config** ([Qwen3Config](/docs/transformers/v4.56.2/en/model_doc/qwen3#transformers.Qwen3Config)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/qwen3/modeling_qwen3.py#L354)
...
elements depending on the configuration ([Qwen3Config](/docs/transformers/v4.56.2/en/model_doc/qwen3#transformers.Qwen3Config)) and inputs.
...
The [Qwen3Model](/docs/transformers/v4.56.2/en/model_doc/qwen3#transformers.Qwen3Model) forward method, overrides the `__call__` special method.
...
### class transformers.Qwen3ForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/qwen3/modeling_qwen3.py#L429)

( config  )

Parameters

* **config** ([Qwen3ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/qwen3#transformers.Qwen3ForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/qwen3/modeling_qwen3.py#L443)
...
The [Qwen3ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/qwen3#transformers.Qwen3ForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.Qwen3ForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/qwen3/modeling_qwen3.py#L509)
...
### class transformers.Qwen3ForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/qwen3/modeling_qwen3.py#L513)
...
### class transformers.Qwen3ForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/qwen3/modeling_qwen3.py#L517)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/qwen3.md)
