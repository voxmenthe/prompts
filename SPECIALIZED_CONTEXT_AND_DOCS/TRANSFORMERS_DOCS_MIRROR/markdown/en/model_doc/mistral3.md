...
The example below demonstrates how to generate text for an image with [Pipeline](/docs/transformers/v4.56.2/en/main_classes/pipelines#transformers.Pipeline) and the [AutoModel](/docs/transformers/v4.56.2/en/model_doc/auto#transformers.AutoModel) class.
...
### class transformers.Mistral3Config
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mistral3/configuration_mistral3.py#L21)

( vision\_config = None text\_config = None image\_token\_index = 10 projector\_hidden\_act = 'gelu' vision\_feature\_layer = -1 multimodal\_projector\_bias = False spatial\_merge\_size = 2 \*\*kwargs  )

Parameters

* **vision\_config** (`Union[AutoConfig, dict]`, *optional*, defaults to `PixtralVisionConfig`) —
  The config object or dictionary of the vision backbone.
* **text\_config** (`Union[AutoConfig, dict]`, *optional*, defaults to `MistralConfig`) —
  The config object or dictionary of the text backbone.
* **image\_token\_index** (`int`, *optional*, defaults to 10) —
...
* **vision\_feature\_layer** (`Union[int, list[int]]`, *optional*, defaults to -1) —
  ...
  vision features.
* **multimodal\_projector\_bias** (`bool`, *optional*, defaults to `False`) —
  Whether to use bias in the multimodal projector.
* **spatial\_merge\_size** (`int`, *optional*, defaults to 2) —
  The downsampling factor for the spatial merge operation.

This is the configuration class to store the configuration of a [Mistral3ForConditionalGeneration](/docs/transformers/v4.56.2/en/model_doc/mistral3#transformers.Mistral3ForConditionalGeneration). It is used to instantiate an
...
### class transformers.Mistral3Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mistral3/modeling_mistral3.py#L199)

( config: Mistral3Config  )

Parameters

* **config** ([Mistral3Config](/docs/transformers/v4.56.2/en/model_doc/mistral3#transformers.Mistral3Config)) —
...
* **vision\_feature\_layer** (`Union[list[int], int, NoneType]`) —
  The index of the layer to select the vision feature. If multiple indices are provided,
  the vision feature of the corresponding indices will be concatenated to form the
  vision features.
...
elements depending on the configuration ([Mistral3Config](/docs/transformers/v4.56.2/en/model_doc/mistral3#transformers.Mistral3Config)) and inputs.
...
The [Mistral3Model](/docs/transformers/v4.56.2/en/model_doc/mistral3#transformers.Mistral3Model) forward method, overrides the `__call__` special method.
...
#### get\_image\_features
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mistral3/modeling_mistral3.py#L222)

( pixel\_values: FloatTensor image\_sizes: Tensor vision\_feature\_layer: typing.Union[list[int], int, NoneType] = None \*\*kwargs  ) → image\_features (`torch.Tensor`)
...
* **vision\_feature\_layer** (`Union[int, list[int]]`, *optional*) —
  ...
  the vision feature of the corresponding indices will be concatenated to form the
  vision features.
* **image\_sizes** (`torch.Tensor`, *optional*) —
...
#### get\_placeholder\_mask
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mistral3/modeling_mistral3.py#L265)
...
### class transformers.Mistral3ForConditionalGeneration
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/mistral3/modeling_mistral3.py#L362)
...
The [Mistral3ForConditionalGeneration](/docs/transformers/v4.56.2/en/model_doc/mistral3#transformers.Mistral3ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/mistral3.md)
