...
### class transformers.GraniteMoeHybridConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoehybrid/configuration_granitemoehybrid.py#L26)

( vocab\_size = 32000 hidden\_size = 4096 intermediate\_size = 11008 num\_hidden\_layers = 32 num\_attention\_heads = 32 num\_key\_value\_heads = None hidden\_act = 'silu' max\_position\_embeddings = 2048 initializer\_range = 0.02 rms\_norm\_eps = 1e-06 use\_cache = True pad\_token\_id = None bos\_token\_id = 1 eos\_token\_id = 2 tie\_word\_embeddings = False rope\_theta = 10000.0 rope\_scaling = None attention\_bias = False attention\_dropout = 0.0 embedding\_multiplier = 1.0 logits\_scaling = 1.0 residual\_multiplier = 1.0 attention\_multiplier = 1.0 num\_local\_experts = 8 num\_experts\_per\_tok = 2 output\_router\_logits = False router\_aux\_loss\_coef = 0.001 shared\_intermediate\_size = 1024 position\_embedding\_type = None layer\_types = None mamba\_n\_heads = 128 mamba\_n\_groups = 1 mamba\_d\_state = 256 mamba\_d\_head = 'auto' mamba\_d\_conv = 4 mamba\_expand = 2 mamba\_chunk\_size = 256 mamba\_conv\_bias = True mamba\_proj\_bias = False \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 32000) —
  ...
  can be represented by the `inputs_ids` passed when calling [GraniteMoeHybridModel](/docs/transformers/v4.56.2/en/model_doc/granitemoehybrid#transformers.GraniteMoeHybridModel)
...
* **router\_aux\_loss\_coef** (`float`, *optional*, defaults to 0.001) — router auxialiary loss coefficient
* **shared\_intermediate\_size** (`int`, *optional*, defaults to 1024) — intermediate size for shared experts.
* **position\_embedding\_type** (`str`, *optional*) — Positional embedding
  type to be used; defaults to None. Allowed options: `[None, "rope"]`
* **layer\_types** (`List`, *optional*) — list of strings to be used as layer types.
...
* **mamba\_proj\_bias** (`bool`, *optional*, defaults to `False`) —
  Flag indicating whether or not to use bias in the input and output projections ([“in\_proj”, “out\_proj”])
  of the mamba mixer block.

This is the configuration class to store the configuration of a [GraniteMoeHybridConfig](/docs/transformers/v4.56.2/en/model_doc/granitemoehybrid#transformers.GraniteMoeHybridConfig). It is used to
...
### class transformers.GraniteMoeHybridModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoehybrid/modeling_granitemoehybrid.py#L1287)

( config: GraniteMoeHybridConfig  )

Parameters

* **config** ([GraniteMoeHybridConfig](/docs/transformers/v4.56.2/en/model_doc/granitemoehybrid#transformers.GraniteMoeHybridConfig)) —
...
elements depending on the configuration ([GraniteMoeHybridConfig](/docs/transformers/v4.56.2/en/model_doc/granitemoehybrid#transformers.GraniteMoeHybridConfig)) and inputs.
...
The [GraniteMoeHybridModel](/docs/transformers/v4.56.2/en/model_doc/granitemoehybrid#transformers.GraniteMoeHybridModel) forward method, overrides the `__call__` special method.
...
### class transformers.GraniteMoeHybridForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoehybrid/modeling_granitemoehybrid.py#L1653)

( config: GraniteMoeHybridConfig  )

#### forward

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/granitemoehybrid/modeling_granitemoehybrid.py#L1669)
...
The [GraniteMoeHybridForCausalLM](/docs/transformers/v4.56.2/en/model_doc/granitemoehybrid#transformers.GraniteMoeHybridForCausalLM) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/granitemoehybrid.md)
