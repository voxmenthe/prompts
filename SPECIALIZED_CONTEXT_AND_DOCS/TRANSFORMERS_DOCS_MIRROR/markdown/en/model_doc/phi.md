...
* If you’re using Transformers < 4.37.0.dev, set `trust_remote_code=True` in [from\_pretrained()](/docs/transformers/v4.56.2/en/model_doc/auto#transformers.AutoModel.from_pretrained). Otherwise, make sure you update Transformers to the latest stable version.
...
### class transformers.PhiConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi/configuration_phi.py#L26)

( vocab\_size = 51200 hidden\_size = 2048 intermediate\_size = 8192 num\_hidden\_layers = 24 num\_attention\_heads = 32 num\_key\_value\_heads = None resid\_pdrop = 0.0 embd\_pdrop = 0.0 attention\_dropout = 0.0 hidden\_act = 'gelu\_new' max\_position\_embeddings = 2048 initializer\_range = 0.02 layer\_norm\_eps = 1e-05 use\_cache = True tie\_word\_embeddings = False rope\_theta = 10000.0 rope\_scaling = None partial\_rotary\_factor = 0.5 qk\_layernorm = False bos\_token\_id = 1 eos\_token\_id = 2 \*\*kwargs  )

Parameters

* **vocab\_size** (`int`, *optional*, defaults to 51200) —
  Vocabulary size of the Phi model. Defines the number of different tokens that can be represented by the
  `inputs_ids` passed when calling [PhiModel](/docs/transformers/v4.56.2/en/model_doc/phi#transformers.PhiModel).
...
* **qk\_layernorm** (`bool`, *optional*, defaults to `False`) —
...
This is the configuration class to store the configuration of a [PhiModel](/docs/transformers/v4.56.2/en/model_doc/phi#transformers.PhiModel). It is used to instantiate an Phi
...
### class transformers.PhiModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi/modeling_phi.py#L315)

( config: PhiConfig  )

Parameters

* **config** ([PhiConfig](/docs/transformers/v4.56.2/en/model_doc/phi#transformers.PhiConfig)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi/modeling_phi.py#L333)
...
elements depending on the configuration ([PhiConfig](/docs/transformers/v4.56.2/en/model_doc/phi#transformers.PhiConfig)) and inputs.
...
The [PhiModel](/docs/transformers/v4.56.2/en/model_doc/phi#transformers.PhiModel) forward method, overrides the `__call__` special method.
...
### class transformers.PhiForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi/modeling_phi.py#L433)

( config  )

Parameters

* **config** ([PhiForCausalLM](/docs/transformers/v4.56.2/en/model_doc/phi#transformers.PhiForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi/modeling_phi.py#L447)
...
The [PhiForCausalLM](/docs/transformers/v4.56.2/en/model_doc/phi#transformers.PhiForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.PhiForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi/modeling_phi.py#L508)
...
### class transformers.PhiForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/phi/modeling_phi.py#L512)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/phi.md)
