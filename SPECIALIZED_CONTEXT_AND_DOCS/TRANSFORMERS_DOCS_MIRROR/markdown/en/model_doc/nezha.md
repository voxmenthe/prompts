...
### class transformers.NezhaConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/configuration_nezha.py#L4)

( vocab\_size = 21128 hidden\_size = 768 num\_hidden\_layers = 12 num\_attention\_heads = 12 intermediate\_size = 3072 hidden\_act = 'gelu' hidden\_dropout\_prob = 0.1 attention\_probs\_dropout\_prob = 0.1 max\_position\_embeddings = 512 max\_relative\_position = 64 type\_vocab\_size = 2 initializer\_range = 0.02 layer\_norm\_eps = 1e-12 classifier\_dropout = 0.1 pad\_token\_id = 0 bos\_token\_id = 2 eos\_token\_id = 3 use\_cache = True \*\*kwargs  )

Parameters

* **vocab\_size** (`int`, optional, defaults to 21128) —
  Vocabulary size of the NEZHA model. Defines the different tokens that can be represented by the
  *inputs\_ids* passed to the forward method of [NezhaModel](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaModel).
...
* **type\_vocab\_size** (`int`, optional, defaults to 2) —
  The vocabulary size of the *token\_type\_ids* passed into [NezhaModel](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaModel).
...
This is the configuration class to store the configuration of an [NezhaModel](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaModel). It is used to instantiate an Nezha
...
### class transformers.NezhaModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L826)

( config add\_pooling\_layer = True  )

Parameters

* **config** ([NezhaConfig](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaConfig)) — Model configuration class with all the parameters of the model.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L865)
...
elements depending on the configuration ([NezhaConfig](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaConfig)) and inputs.
...
The [NezhaModel](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaModel) forward method, overrides the `__call__` special method.
...
### class transformers.NezhaForPreTraining
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1006)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1025)
...
The [NezhaForPreTraining](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaForPreTraining) forward method, overrides the `__call__` special method.
...
### class transformers.NezhaForMaskedLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1109)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1134)
...
The [NezhaForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaForMaskedLM) forward method, overrides the `__call__` special method.
...
### class transformers.NezhaForNextSentencePrediction
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1216)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1226)
...
The [NezhaForNextSentencePrediction](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
### class transformers.NezhaForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1319)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1335)
...
The [NezhaForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.NezhaForMultipleChoice
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1418)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1432)
...
The [NezhaForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaForMultipleChoice) forward method, overrides the `__call__` special method.
...
### class transformers.NezhaForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1510)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1525)
...
The [NezhaForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaForTokenClassification) forward method, overrides the `__call__` special method.
...
### class transformers.NezhaForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1589)
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/deprecated/nezha/modeling_nezha.py#L1600)
...
The [NezhaForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/nezha#transformers.NezhaForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/nezha.md)
