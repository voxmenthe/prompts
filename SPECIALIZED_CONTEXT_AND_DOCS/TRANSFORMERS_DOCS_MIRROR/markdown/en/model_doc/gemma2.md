...
![](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/model_doc/gemma-2-attn-mask.png)

## Gemma2Config

### class transformers.Gemma2Config

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gemma2/configuration_gemma2.py#L25)
...
* **vocab\_size** (`int`, *optional*, defaults to 256000) —
  ...
  `inputs_ids` passed when calling [Gemma2Model](/docs/transformers/v4.56.2/en/model_doc/gemma2#transformers.Gemma2Model)
...
This is the configuration class to store the configuration of a [Gemma2Model](/docs/transformers/v4.56.2/en/model_doc/gemma2#transformers.Gemma2Model). It is used to instantiate an Gemma2
...
### class transformers.Gemma2Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gemma2/modeling_gemma2.py#L358)

( config: Gemma2Config  )

Parameters

* **config** ([Gemma2Config](/docs/transformers/v4.56.2/en/model_doc/gemma2#transformers.Gemma2Config)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gemma2/modeling_gemma2.py#L375)
...
elements depending on the configuration ([Gemma2Config](/docs/transformers/v4.56.2/en/model_doc/gemma2#transformers.Gemma2Config)) and inputs.
...
The [Gemma2Model](/docs/transformers/v4.56.2/en/model_doc/gemma2#transformers.Gemma2Model) forward method, overrides the `__call__` special method.
...
### class transformers.Gemma2ForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gemma2/modeling_gemma2.py#L488)

( config  )

Parameters

* **config** ([Gemma2ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/gemma2#transformers.Gemma2ForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gemma2/modeling_gemma2.py#L502)
...
The [Gemma2ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/gemma2#transformers.Gemma2ForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.Gemma2ForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gemma2/modeling_gemma2.py#L582)
...
### class transformers.Gemma2ForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gemma2/modeling_gemma2.py#L586)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/gemma2.md)
