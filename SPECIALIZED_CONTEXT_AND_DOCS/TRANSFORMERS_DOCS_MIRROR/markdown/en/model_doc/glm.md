...
### class transformers.GlmConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm/configuration_glm.py#L20)
...
* **vocab\_size** (`int`, *optional*, defaults to 151552) —
  ...
  `inputs_ids` passed when calling [GlmModel](/docs/transformers/v4.56.2/en/model_doc/glm#transformers.GlmModel)
...
This is the configuration class to store the configuration of a [GlmModel](/docs/transformers/v4.56.2/en/model_doc/glm#transformers.GlmModel). It is used to instantiate an Glm
...
### class transformers.GlmModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm/modeling_glm.py#L344)

( config: GlmConfig  )

Parameters

* **config** ([GlmConfig](/docs/transformers/v4.56.2/en/model_doc/glm#transformers.GlmConfig)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm/modeling_glm.py#L361)
...
elements depending on the configuration ([GlmConfig](/docs/transformers/v4.56.2/en/model_doc/glm#transformers.GlmConfig)) and inputs.
...
The [GlmModel](/docs/transformers/v4.56.2/en/model_doc/glm#transformers.GlmModel) forward method, overrides the `__call__` special method.
...
### class transformers.GlmForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm/modeling_glm.py#L423)

( config  )

Parameters

* **config** ([GlmForCausalLM](/docs/transformers/v4.56.2/en/model_doc/glm#transformers.GlmForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm/modeling_glm.py#L437)
...
The [GlmForCausalLM](/docs/transformers/v4.56.2/en/model_doc/glm#transformers.GlmForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.GlmForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm/modeling_glm.py#L498)
...
### class transformers.GlmForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm/modeling_glm.py#L502)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/glm.md)
