...
The [generate()](/docs/transformers/v4.56.2/en/main_classes/text_generation#transformers.GenerationMixin.generate) method can be used to generate text using GPT-J
model.
...
### class transformers.GPTJConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/configuration_gptj.py#L30)

( vocab\_size = 50400 n\_positions = 2048 n\_embd = 4096 n\_layer = 28 n\_head = 16 rotary\_dim = 64 n\_inner = None activation\_function = 'gelu\_new' resid\_pdrop = 0.0 embd\_pdrop = 0.0 attn\_pdrop = 0.0 layer\_norm\_epsilon = 1e-05 initializer\_range = 0.02 use\_cache = True bos\_token\_id = 50256 eos\_token\_id = 50256 tie\_word\_embeddings = False \*\*kwargs  )

Parameters

* **vocab\_size** (`int`, *optional*, defaults to 50400) —
  Vocabulary size of the GPT-J model. Defines the number of different tokens that can be represented by the
  `inputs_ids` passed when calling [GPTJModel](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJModel).
...
This is the configuration class to store the configuration of a [GPTJModel](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJModel). It is used to instantiate a GPT-J
...
### class transformers.GPTJModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/modeling_gptj.py#L548)

( config  )

Parameters

* **config** ([GPTJModel](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJModel)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/modeling_gptj.py#L617)
...
elements depending on the configuration ([GPTJConfig](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJConfig)) and inputs.
...
The [GPTJModel](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJModel) forward method, overrides the `__call__` special method.
...
### class transformers.GPTJForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/modeling_gptj.py#L885)

( config  )

Parameters

* **config** ([GPTJForCausalLM](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/modeling_gptj.py#L931)
...
The [GPTJForCausalLM](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.GPTJForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/modeling_gptj.py#L1028)

( config  )

Parameters

* **config** ([GPTJForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJForSequenceClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
[GPTJForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJForSequenceClassification) uses the last token in order to do the classification, as other causal models
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/modeling_gptj.py#L1042)
...
The [GPTJForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.GPTJForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/modeling_gptj.py#L1146)

( config  )

Parameters

* **config** ([GPTJForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJForQuestionAnswering)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/gptj/modeling_gptj.py#L1160)
...
The [GPTJForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/gptj#transformers.GPTJForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/gptj.md)
