...
![drawing](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/yoso_architecture.jpg) YOSO Attention Algorithm. Taken from the [original paper](https://huggingface.co/papers/2111.09714).
...
### class transformers.YosoConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/configuration_yoso.py#L24)

( vocab\_size = 50265 hidden\_size = 768 num\_hidden\_layers = 12 num\_attention\_heads = 12 intermediate\_size = 3072 hidden\_act = 'gelu' hidden\_dropout\_prob = 0.1 attention\_probs\_dropout\_prob = 0.1 max\_position\_embeddings = 4096 type\_vocab\_size = 1 initializer\_range = 0.02 layer\_norm\_eps = 1e-12 position\_embedding\_type = 'absolute' use\_expectation = True hash\_code\_len = 9 num\_hash = 64 conv\_window = None use\_fast\_hash = True lsh\_backward = True pad\_token\_id = 1 bos\_token\_id = 0 eos\_token\_id = 2 \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 50265) —
  ...
  `inputs_ids` passed when calling [YosoModel](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoModel).
...
* **type\_vocab\_size** (`int`, *optional*, defaults to 2) —
  The vocabulary size of the `token_type_ids` passed when calling [YosoModel](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoModel).
...
* **use\_expectation** (`bool`, *optional*, defaults to `True`) —
  Whether or not to use YOSO Expectation. Overrides any effect of num\_hash.
* **hash\_code\_len** (`int`, *optional*, defaults to 9) —
  The length of hashes generated by the hash functions.
* **num\_hash** (`int`, *optional*, defaults to 64) —
  Number of hash functions used in `YosoSelfAttention`.
* **conv\_window** (`int`, *optional*) —
  Kernel size of depth-wise convolution.
* **use\_fast\_hash** (`bool`, *optional*, defaults to `False`) —
  Whether or not to use custom cuda kernels which perform fast random projection via hadamard transform.
* **lsh\_backward** (`bool`, *optional*, defaults to `True`) —
  Whether or not to perform backpropagation using Locality Sensitive Hashing.

This is the configuration class to store the configuration of a [YosoModel](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoModel). It is used to instantiate an YOSO
...
### class transformers.YosoModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L667)

( config  )

Parameters

* **config** ([YosoModel](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoModel)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L692)
...
elements depending on the configuration ([YosoConfig](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoConfig)) and inputs.
...
The [YosoModel](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoModel) forward method, overrides the `__call__` special method.
...
### class transformers.YosoForMaskedLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L770)

( config  )

Parameters

* **config** ([YosoForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForMaskedLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L789)
...
The [YosoForMaskedLM](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForMaskedLM) forward method, overrides the `__call__` special method.
...
### class transformers.YosoForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L870)

( config  )

Parameters

* **config** ([YosoForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForSequenceClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L880)
...
The [YosoForSequenceClassification](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForSequenceClassification) forward method, overrides the `__call__` special method.
...
### class transformers.YosoForMultipleChoice
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L952)

( config  )

Parameters

* **config** ([YosoForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForMultipleChoice)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L963)
...
The [YosoForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForMultipleChoice) forward method, overrides the `__call__` special method.
...
### class transformers.YosoForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L1058)

( config  )

Parameters

* **config** ([YosoForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForTokenClassification)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L1070)
...
The [YosoForTokenClassification](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForTokenClassification) forward method, overrides the `__call__` special method.
...
### class transformers.YosoForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L1134)

( config  )

Parameters

* **config** ([YosoForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForQuestionAnswering)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/yoso/modeling_yoso.py#L1147)
...
The [YosoForQuestionAnswering](/docs/transformers/v4.56.2/en/model_doc/yoso#transformers.YosoForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/yoso.md)
