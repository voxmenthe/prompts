...
### class transformers.SmolLM3Config
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/smollm3/configuration_smollm3.py#L26)

( vocab\_size = 128256 hidden\_size = 2048 intermediate\_size = 11008 num\_hidden\_layers = 36 num\_attention\_heads = 16 num\_key\_value\_heads = 4 hidden\_act = 'silu' max\_position\_embeddings = 32768 initializer\_range = 0.02 rms\_norm\_eps = 1e-06 use\_cache = True pad\_token\_id = 128004 bos\_token\_id = 128000 eos\_token\_id = 128001 rope\_theta = 2000000.0 rope\_scaling = None use\_sliding\_window = False sliding\_window = None no\_rope\_layers = None no\_rope\_layer\_interval = 4 layer\_types = None attention\_bias = False attention\_dropout = 0.0 mlp\_bias = False \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 128256) —
  ...
  `inputs_ids` passed when calling [SmolLM3Model](/docs/transformers/v4.56.2/en/model_doc/smollm3#transformers.SmolLM3Model)
...
* **rope\_theta** (`float`, *optional*, defaults to 2000000.0) —
...
This is the configuration class to store the configuration of a [SmolLM3Model](/docs/transformers/v4.56.2/en/model_doc/smollm3#transformers.SmolLM3Model). It is used to instantiate a
...
### class transformers.SmolLM3Model
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/smollm3/modeling_smollm3.py#L340)

( config: SmolLM3Config  )

Parameters

* **config** ([SmolLM3Config](/docs/transformers/v4.56.2/en/model_doc/smollm3#transformers.SmolLM3Config)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/smollm3/modeling_smollm3.py#L358)
...
elements depending on the configuration ([SmolLM3Config](/docs/transformers/v4.56.2/en/model_doc/smollm3#transformers.SmolLM3Config)) and inputs.
...
The [SmolLM3Model](/docs/transformers/v4.56.2/en/model_doc/smollm3#transformers.SmolLM3Model) forward method, overrides the `__call__` special method.
...
### class transformers.SmolLM3ForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/smollm3/modeling_smollm3.py#L433)

( config  )

Parameters

* **config** ([SmolLM3ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/smollm3#transformers.SmolLM3ForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/smollm3/modeling_smollm3.py#L447)
...
The [SmolLM3ForCausalLM](/docs/transformers/v4.56.2/en/model_doc/smollm3#transformers.SmolLM3ForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.SmolLM3ForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/smollm3/modeling_smollm3.py#L508)
...
### class transformers.SmolLM3ForTokenClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/smollm3/modeling_smollm3.py#L512)
...
### class transformers.SmolLM3ForQuestionAnswering
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/smollm3/modeling_smollm3.py#L516)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/smollm3.md)
