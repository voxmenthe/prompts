...
### class transformers.Glm4MoeConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm4_moe/configuration_glm4_moe.py#L26)

( vocab\_size = 151552 hidden\_size = 4096 intermediate\_size = 10944 num\_hidden\_layers = 46 num\_attention\_heads = 96 partial\_rotary\_factor = 0.5 num\_key\_value\_heads = 8 hidden\_act = 'silu' max\_position\_embeddings = 131072 initializer\_range = 0.02 rms\_norm\_eps = 1e-05 use\_cache = True tie\_word\_embeddings = False rope\_theta = 10000.0 rope\_scaling = None attention\_bias = False attention\_dropout = 0.0 moe\_intermediate\_size = 1408 num\_experts\_per\_tok = 8 n\_shared\_experts = 1 n\_routed\_experts = 128 routed\_scaling\_factor = 1.0 n\_group = 1 topk\_group = 1 first\_k\_dense\_replace = 1 norm\_topk\_prob = True use\_qk\_norm = False \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 151552) —
  ...
  `inputs_ids` passed when calling [Glm4MoeModel](/docs/transformers/v4.56.2/en/model_doc/glm4_moe#transformers.Glm4MoeModel)
...
This is the configuration class to store the configuration of a [Glm4MoeModel](/docs/transformers/v4.56.2/en/model_doc/glm4_moe#transformers.Glm4MoeModel). It is used to instantiate a
...
### class transformers.Glm4MoeModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm4_moe/modeling_glm4_moe.py#L460)

( config: Glm4MoeConfig  )

Parameters

* **config** ([Glm4MoeConfig](/docs/transformers/v4.56.2/en/model_doc/glm4_moe#transformers.Glm4MoeConfig)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm4_moe/modeling_glm4_moe.py#L479)
...
elements depending on the configuration ([Glm4MoeConfig](/docs/transformers/v4.56.2/en/model_doc/glm4_moe#transformers.Glm4MoeConfig)) and inputs.
...
The [Glm4MoeModel](/docs/transformers/v4.56.2/en/model_doc/glm4_moe#transformers.Glm4MoeModel) forward method, overrides the `__call__` special method.
...
### class transformers.Glm4MoeForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm4_moe/modeling_glm4_moe.py#L541)

( config  )

Parameters

* **config** ([Glm4MoeForCausalLM](/docs/transformers/v4.56.2/en/model_doc/glm4_moe#transformers.Glm4MoeForCausalLM)) —
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from\_pretrained()](/docs/transformers/v4.56.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/glm4_moe/modeling_glm4_moe.py#L555)
...
The [Glm4MoeForCausalLM](/docs/transformers/v4.56.2/en/model_doc/glm4_moe#transformers.Glm4MoeForCausalLM) forward method, overrides the `__call__` special method.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/glm4_moe.md)
