...
### class transformers.JetMoeConfig
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/jetmoe/configuration_jetmoe.py#L24)

( vocab\_size = 32000 hidden\_size = 2048 num\_hidden\_layers = 12 num\_key\_value\_heads = 16 kv\_channels = 128 intermediate\_size = 5632 max\_position\_embeddings = 4096 activation\_function = 'silu' num\_local\_experts = 8 num\_experts\_per\_tok = 2 output\_router\_logits = False aux\_loss\_coef = 0.01 use\_cache = True bos\_token\_id = 1 eos\_token\_id = 2 tie\_word\_embeddings = True rope\_theta = 10000.0 rms\_norm\_eps = 1e-06 initializer\_range = 0.01 attention\_dropout = 0.0 \*\*kwargs  )
...
* **vocab\_size** (`int`, *optional*, defaults to 32000) —
  ...
  `inputs_ids` passed when calling [JetMoeModel](/docs/transformers/v4.56.2/en/model_doc/jetmoe#transformers.JetMoeModel)
...
* **kv\_channels** (`int`, *optional*, defaults to 128) —
...
* **max\_position\_embeddings** (`int`, *optional*, defaults to 4096) —
  ...
  up to 4096 tokens.
* **activation\_function** (`string`, *optional*, defaults to `"silu"`) —
...
* **aux\_loss\_coef** (`float`, *optional*, defaults to 0.01) —
...
This is the configuration class to store the configuration of a [JetMoeModel](/docs/transformers/v4.56.2/en/model_doc/jetmoe#transformers.JetMoeModel). It is used to instantiate a
...
### class transformers.JetMoeModel
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/jetmoe/modeling_jetmoe.py#L865)

( config: JetMoeConfig  )

Parameters

* **config** ([JetMoeConfig](/docs/transformers/v4.56.2/en/model_doc/jetmoe#transformers.JetMoeConfig)) —
...
#### forward
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/jetmoe/modeling_jetmoe.py#L888)
...
elements depending on the configuration ([JetMoeConfig](/docs/transformers/v4.56.2/en/model_doc/jetmoe#transformers.JetMoeConfig)) and inputs.
...
The [JetMoeModel](/docs/transformers/v4.56.2/en/model_doc/jetmoe#transformers.JetMoeModel) forward method, overrides the `__call__` special method.
...
### class transformers.JetMoeForCausalLM
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/jetmoe/modeling_jetmoe.py#L1112)

( config  )

#### forward

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/jetmoe/modeling_jetmoe.py#L1126)
...
The [JetMoeForCausalLM](/docs/transformers/v4.56.2/en/model_doc/jetmoe#transformers.JetMoeForCausalLM) forward method, overrides the `__call__` special method.
...
### class transformers.JetMoeForSequenceClassification
 ...
 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/models/jetmoe/modeling_jetmoe.py#L1205)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/model_doc/jetmoe.md)
