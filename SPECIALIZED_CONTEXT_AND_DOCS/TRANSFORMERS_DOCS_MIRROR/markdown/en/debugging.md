...
Now that you know where the error is happening, you can investigate the modeling code in [modeling\_t5.py](https://github.com/huggingface/transformers/blob/main/src/transformers/models/t5/modeling_t5.py).
...
Finally, you can configure the number of frames printed by [DebugUnderflowOverflow](/docs/transformers/v4.56.2/en/internal/trainer_utils#transformers.debug_utils.DebugUnderflowOverflow).
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/debugging.md)
