...
The first one will contain a summary of each module’s *input* and *output* tensor values and shapes.
...
#### transformers.model\_addition\_debugger\_context

 [< source >](https://github.com/huggingface/transformers/blob/v4.56.2/src/transformers/model_debugging_utils.py#L397)

( model debug\_path: typing.Optional[str] = None do\_prune\_layers: typing.Optional[bool] = True use\_repr: typing.Optional[bool] = True  )
...
* scans all test\_modeling\_common methods
* looks for times where a method is skipped
* returns a summary json you can load as a DataFrame/inspect

**For instance test\_inputs\_embeds is skipped in a whooping 39% proportion at the time of writing this util.**
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/internal/model_debugging_utils.md)
