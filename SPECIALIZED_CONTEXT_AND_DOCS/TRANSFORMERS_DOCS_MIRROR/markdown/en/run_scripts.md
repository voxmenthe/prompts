...
The example script downloads and preprocesses a dataset, and then fine-tunes it with [Trainer](/docs/transformers/v4.56.2/en/main_classes/trainer#transformers.Trainer) with a supported model architecture.
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/run_scripts.md)
