...
You’re ready to start training your model now! Load BERT with [AutoModelForMultipleChoice](/docs/transformers/v4.56.2/en/model_doc/auto#transformers.AutoModelForMultipleChoice):
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/tasks/multiple_choice.md)
