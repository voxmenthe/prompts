...
The IDEFICS processor wraps a [LlamaTokenizer](/docs/transformers/v4.56.2/en/model_doc/llama#transformers.LlamaTokenizer) and IDEFICS image processor into a single processor to take care of
...
![Image of a puppy in a flower bed](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/idefics-im-captioning.jpg)
...
![Image of the Eiffel Tower at night](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/idefics-prompted-im-captioning.jpg)
...
![Image of the Statue of Liberty](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/idefics-few-shot.jpg)
...
![Image of a couple having a picnic](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/idefics-vqa.jpg)
...
![Image of a vegetable stand](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/idefics-classification.jpg)
...
![Image of a red door with a pumpkin on the steps](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/idefics-story-generation.jpg)
...
[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/tasks/idefics.md)
