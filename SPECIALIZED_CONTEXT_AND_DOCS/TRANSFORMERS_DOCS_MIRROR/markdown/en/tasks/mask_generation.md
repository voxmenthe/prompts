...
![SAM Architecture](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/sam.png)
...
![Example Image](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/bee.jpg)
...
![Visualized](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/bee_segmented.png)
...
![Visualized](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/masks.png)
...
![Visualized Bbox](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/bbox.png)
...
![Visualized Inference](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/box_inference.png)

[< > Update on GitHub](https://github.com/huggingface/transformers/blob/main/docs/source/en/tasks/mask_generation.md)
